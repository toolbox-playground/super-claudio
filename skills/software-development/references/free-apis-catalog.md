...
| API | What | URL | Auth |
|-----|------|-----|------|
| Google Gemini API | LLM inference — **free tier is Flash-only now: Google pulled Pro models (3.1 Pro, 3 Pro) from the free tier April 1, 2026 (paid-only)**; free access covers Flash/Flash-Lite, currently **Gemini 3.7 Flash** (released Aug 13, 2026, replacing 3.6/3.5 Flash as default), 1M token context, multimodal, 60 RPM | ai.google.dev | Free key (Flash/Flash-Lite only; Pro is paid) |
...
| **GitHub Models** | **⚠️ Fully retired (July 30, 2026)** — playground, model catalog, inference API, and BYOK all shut down; no longer available to any customer. For free-tier AI model access, use Groq, Cerebras Inference, OpenRouter free models, or Cloudflare Workers AI instead. | github.com/features/models | Defunct |
