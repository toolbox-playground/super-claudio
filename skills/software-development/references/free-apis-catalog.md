...
| **GitHub Models** | **⚠️ Fully retired July 30, 2026** — playground, model catalog, inference API, and BYOK support all shut down for every customer, including existing users. GitHub points migrants to Azure AI Foundry (not free), direct provider APIs, or an OpenAI-compatible gateway like OpenRouter. Use Groq, OpenRouter, or Cerebras Inference instead for free multi-model access. | github.com/features/models | Discontinued |
