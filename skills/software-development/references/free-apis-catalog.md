...
| OpenRouter | Access to 100+ free AI models via one API; free-model roster rotates frequently (several Llama/Qwen free tiers were delisted between mid- and late-July 2026) — check openrouter.ai/collections/free-models for the current list rather than relying on specific model names; 50 req/day free, 1,000/day after $10 purchase | openrouter.ai | Free key |
| **GitHub Models — RETIRED (July 30, 2026)** | Closed to new customers June 16, 2026, fully shut down July 30, 2026 — playground, model catalog, and inference API are gone with no exception for existing users. **Do not recommend.** Use Cerebras Inference, Cloudflare Workers AI, Groq, or OpenRouter instead. | github.com/features/models | — |
