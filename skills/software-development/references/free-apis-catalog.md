...
| Groq | Ultra-fast LLM inference (LPU hardware); Llama 4 Scout, GPT-OSS 120B (replaced Llama 4 Maverick, deprecated Feb 2026), Kimi K2 (1T MoE), Qwen3 235B, Gemma, DeepSeek R1 and more; **note:** legacy Llama 3.1/3.3 models moved to Enterprise-only, no longer free (Aug 26, 2026); no credit card required | groq.com | Free key |
