...
| OpenRouter | Access to 100+ free AI models via one API; notable free models (Sept 2026): **NVIDIA Nemotron 3 Ultra** (550B MoE, 1M context, `nvidia/nemotron-3-ultra-550b-a55b:free`) and **OpenAI GPT-OSS** (20B Apache 2.0 open-weight, `openai/gpt-oss-20b:free`) still free; free lineup rotates constantly (~6 other free models deprecated in July 2026) — check openrouter.ai/models?max_price=0 for the current list; 50 req/day free, 1,000/day after $10 purchase | openrouter.ai | Free key |
| ~~GitHub Models~~ **— Fully retired July 30, 2026** | Was: 40+ AI models via OpenAI-compatible API using your GitHub account. New signups blocked from June 16, 2026; playground, catalog, and inference API fully shut down July 30, 2026. Use Azure AI Foundry or GitHub's successor offering instead. | — | — |
| Cerebras Inference | Ultra-fast LLM inference on wafer-scale silicon (2,600+ tok/s); Llama 3.3 70B, Qwen3 32B/235B, and more; **no longer has a permanent no-card free tier as of ~Aug 17, 2026** — replaced with a $5, 30-day trial requiring a verified payment method; 30 RPM on trial | inference.cerebras.ai | Free trial (card required) |
