...
## ElevenLabs v4 — Limited Early Access Opens (Not Yet GA)

ElevenLabs previewed its next-generation v4 voice model at ElevenSummit in Warsaw (June 2026). In early August 2026, ElevenLabs opened a **limited early-access waitlist** for v4 to select enterprise customers — there is still no public model ID, self-serve API endpoint, or general-availability date. Early-access testers report the same "performance acting" quality demonstrated at the Warsaw preview — expressive delivery with emotion, intent, and accent — plus noticeably lower latency than Multilingual v2. Full GA is expected in H2 2026. Check elevenlabs.io/changelog for updates or to request early access.
...
## Qwen-Audio-3.0-TTS-Plus (Alibaba) — #2 Artificial Analysis TTS Arena (Elo 1,235, Mid-August 2026)

Alibaba's Qwen-Audio-3.0-TTS-Plus (distinct from the open-source Qwen3-TTS listed below) briefly took **#1 on the Artificial Analysis Speech Arena Leaderboard** in mid-July 2026, narrowly surpassing Speechify SIMBA 3.2 — overlapping confidence intervals kept the margin close throughout. A fresh round of Arena voting in mid-August 2026 flipped the lead back to SIMBA 3.2 (now #1, Elo 1,237); Qwen-Audio-3.0-TTS-Plus sits **#2** (Elo 1,235). Delivers increased naturalness and contextually appropriate intonation; available as a proprietary cloud-hosted model via Alibaba Cloud Model Studio (DashScope). Continues Alibaba's momentum across model categories following HappyHorse and Fun-Realtime-TTS.

- **URL:** alibabacloud.com (Model Studio / DashScope)
- **Elo:** 1,235 — **#2 globally (Artificial Analysis Speech Arena, mid-August 2026)**; held #1 briefly in mid-July 2026 (1,236) before SIMBA 3.2 reclaimed the top spot (1,237) in the mid-August Arena update — overlapping confidence intervals keep the two effectively co-equal on quality
...
## Speechify SIMBA 3.2 — #1 Artificial Analysis TTS Arena at $10/1M Characters (Mid-August 2026)

Speechify SIMBA 3.2 (July 2026) reached **#1 on the Artificial Analysis TTS Arena**, was narrowly surpassed by Qwen-Audio-3.0-TTS-Plus in mid-July 2026 (#2, Elo 1,234), then reclaimed **#1** in a mid-August 2026 Arena voting update (**Elo 1,237**; overlapping confidence intervals with Qwen keep the two effectively co-equal on quality) — at $10/1M characters ($6/1M at the Scale tier), the lowest price among current global top-5 models. SIMBA 3.0 (May 2026) entered at #7 (Elo 1,159); 3.2 improved emotional control, locale coverage, and streaming latency, and has held the #1/#2 spot in a tight race with Qwen-Audio-3.0-TTS-Plus since.
...
| Best blind-test naturalness (cloud) | Speechify SIMBA 3.2 (Elo 1,237, **#1** mid-August 2026), Qwen-Audio-3.0-TTS-Plus (Elo 1,235, **#2** mid-August 2026), Gemini 3.1 Flash TTS (Elo ~1,214, **~#3**), Cartesia Sonic 3.5 (Elo ~1,207, **~#4**) |
...
| Top quality at minimum cost | Speechify SIMBA 3.2 (**#1 globally** mid-August 2026, Elo 1,237, $10/1M chars; $6/1M at Scale tier) — best price/quality; Qwen-Audio-3.0-TTS-Plus is now #2 (Elo 1,235, Alibaba DashScope) but has slower throughput (16 chars/sec) |
...
| Highest-ranked cloud TTS by Elo, real-time streaming | Speechify SIMBA 3.2 ($10/1M chars, Elo 1,237, **#1** mid-August 2026); Qwen-Audio-3.0-TTS-Plus (Alibaba DashScope, Elo 1,235, **#2**); Gemini 3.1 Flash TTS (free in AI Studio, Elo ~1,214, ~#3); Cartesia Sonic 3.5 (free tier, Elo ~1,207, ~#4, ~40ms latency) |
