...
Inworld Realtime TTS-2 (launched May 5, 2026) is a fundamentally different architecture from TTS-1.5: it takes the actual audio of prior conversation turns as input — not just text — so it understands tone, pacing, and emotional context from everything that was said before. As of August 2026 the **Research Preview variant ranks #4 on the Artificial Analysis Speech Arena** (Elo 1,226). There's also a **TTS-2 Flash** variant trading some quality for speed: 25ms TTFB vs <100ms for the base TTS-2 model.

- **URL:** inworld.ai
- **Free tier:** 40 minutes/month (On-Demand plan)
- **Pricing:** $35/1M characters (On-Demand); $25/1M characters (Growth plan)
- **Latency:** <200ms median TTFA (base TTS-2); 25ms TTFB on the TTS-2 Flash variant
...
## Inworld AI TTS-1.5 Max — Deprecated in Favor of TTS-2 (Aug 2026)

Inworld TTS-1.5 Max briefly held #1 on the Artificial Analysis Speech Arena in July 2026. As of August 2026, **Inworld's own docs list the entire 1.5 family (TTS-1.5 Max, TTS-1.5 Mini, and the older TTS-1/TTS-1-Max) as deprecated and "not recommended for new projects"** — it remains available for backwards compatibility, but Inworld now directs new integrations to `inworld-tts-2` instead, which adds natural-language steering across 8 delivery dimensions and stronger multilingual support. The oldest models (`inworld-tts-1`, `inworld-tts-1-max`) were fully discontinued June 15, 2026.

- URL: inworld.ai
- Free tier: 40 minutes/month
- Latency: <200ms streaming
- **Status: deprecated for new projects (Aug 2026)** — use `inworld-tts-2` instead; peak Elo was 1,238 in early July 2026 before Cartesia Sonic 3.6 and others surpassed it
- Best for: existing integrations already on this model; new projects should start on TTS-2
- Pricing: $15–$25/million characters (standard)

## Fun-Realtime-TTS (Alibaba Cloud) — Formerly Top-3, Now Mid-Pack (Aug 2026)

Alibaba's Fun-Realtime-TTS briefly held #1 on the Artificial Analysis Speech Arena on June 3, 2026 (Elo 1,219). Since then the top of the board has gotten much more crowded — Cartesia Sonic 3.6, Qwen-Audio-3.0-TTS-Plus, Speechify SIMBA 3.2, Inworld Realtime TTS-2 Flash, and Luna TTS have all risen above its June Elo — so as of August 2026 it's no longer top-3, though its underlying feature set (streaming, voice cloning, voice design, regional accent recognition via DashScope) is unchanged.
...
- **Elo:** 1,219 (June 2026 peak); no longer top-3 as of Aug 2026 — five newer/updated models now rank above it
...
Google's Gemini 3.1 Flash TTS (launched April 15, 2026) delivers natural, expressive speech with inline audio tags for style and pacing control — and is currently free in AI Studio during preview. Held #1 through May 2026 and has since been surpassed by a wave of new entrants; as of August 2026 it sits **around #6 on the Artificial Analysis TTS Arena** (Elo ~1,213), behind Cartesia Sonic 3.6, Qwen-Audio-3.0-TTS-Plus, Speechify SIMBA 3.2, Inworld Realtime TTS-2 Flash, and Luna TTS — still ahead of ElevenLabs Eleven v3.
...
- **Elo:** ~1,213 on Artificial Analysis TTS Arena — **~#6 globally (Aug 2026)**; held #1 through May 2026 before Fun-Realtime-TTS, Cartesia Sonic 3.6, Qwen-Audio-3.0-TTS-Plus, Speechify SIMBA 3.2, and Inworld Realtime TTS-2 Flash rose above it
...
## Cartesia Sonic 3.6 — #1 Artificial Analysis Speech Arena (Elo 1,288, Aug 2026)

Cartesia shipped Sonic 3.6 on August 18, 2026, three months after Sonic 3.5. It's now **#1 on both the Artificial Analysis provider and controlled-voice streaming leaderboards** (Elo 1,288), running on state-space models (not transformers) with sub-90ms time-to-first-audio and native support across 44 languages (adds Odia and Urdu). In blind head-to-head tests across 15 locales, listeners preferred 3.6 over 3.5 in up to 93% of comparisons, and preferred it over ElevenLabs Eleven v3 92% of the time in US English. Generation speed is ~2× faster than the old Conversational v3 model (132 vs 68 chars/sec). GA now — the upgrade applies automatically to existing Cartesia integrations.

- URL: cartesia.ai
- Free tier available; paid plans start at Pro ($5/mo commercial use)
- Latency: sub-90ms TTFA (vendor-stated; Sonic 3.5 claimed ~40ms — benchmark your own round-trip since the marketing metric changed)
- Languages: 44 (added Odia, Urdu in 3.6)
- Elo: 1,288 — **#1 globally (Artificial Analysis Speech Arena, Aug 2026)**, surpassing Qwen-Audio-3.0-TTS-Plus and Speechify SIMBA 3.2
- Best for: voice agents, live chatbots, real-time assistants — now leads on quality as well as latency
...
## Qwen-Audio-3.0-TTS-Plus (Alibaba) — #2 Artificial Analysis TTS Arena (Elo 1,243, Aug 2026)

Alibaba's Qwen-Audio-3.0-TTS-Plus (distinct from the open-source Qwen3-TTS listed below) held **#1 on the Artificial Analysis Speech Arena Leaderboard** through mid-to-late July 2026, and as of August 2026 sits **#2** (Elo 1,243) after Cartesia Sonic 3.6 took the top spot. Delivers increased naturalness and contextually appropriate intonation; available as a proprietary cloud-hosted model via Alibaba Cloud Model Studio (DashScope). Continues Alibaba's momentum across model categories following HappyHorse and Fun-Realtime-TTS.

- **URL:** alibabacloud.com (Model Studio / DashScope)
- **Elo:** 1,243 — **#2 globally (Artificial Analysis Speech Arena, Aug 2026)**; behind Cartesia Sonic 3.6 (1,288), ahead of Speechify SIMBA 3.2 (1,239)
- **Free tier:** Alibaba Cloud trial credits on new accounts; no permanent free tier
- **Generation speed:** ~16 chars/sec — significantly slower than Sonic 3.6 (~132 chars/sec) and SIMBA 3.2 (~30 chars/sec); note for throughput-sensitive pipelines
...
## Speechify SIMBA 3.2 — #3 Artificial Analysis TTS Arena at $10/1M Characters (Aug 2026)

Speechify SIMBA 3.2 (July 2026) briefly reached #1 on the Artificial Analysis TTS Arena in mid-July 2026, then was surpassed by Qwen-Audio-3.0-TTS-Plus and now, as of August 2026, sits **#3** (Elo 1,239) behind Cartesia Sonic 3.6 and Qwen-Audio-3.0-TTS-Plus — still at $10/1M characters ($6/1M at the Scale tier), the lowest price among the current global top-5 models. SIMBA 3.0 (May 2026) entered at #7 (Elo 1,159); 3.2 improved emotional control, locale coverage, and streaming latency.
...
## Luna-TTS (VUI Labs) — #5 Artificial Analysis TTS Arena, 41.6ms Latency (NEW Aug 2026)

Luna-TTS is a new entrant from Chinese voice AI startup VUI Labs, first appearing on leaderboards in August 2026. It's fully non-autoregressive — a diffusion-based architecture (built on a Qwen3 backbone) that generates an utterance's full audio-token grid in parallel refinement steps rather than token-by-token, with zero-shot voice cloning and speech editing arising natively from that as infilling. It ranked #1 on the HuggingFace TTS Arena (beating ElevenLabs, MiniMax, and Cartesia there) and **#5 on the Artificial Analysis Speech Arena** (Elo 1,225) — notable as one of the only top-10 models from a small independent lab rather than a major AI company.

- **URL:** vuilabs.ai
- **Architecture:** Non-autoregressive diffusion, Qwen3-based backbone; trained on 1M+ hours of speech
- **Languages:** Chinese, English, Japanese, Korean
- **Latency:** 41.6ms first-packet
- **Elo:** 1,225 — **#5 globally (Artificial Analysis Speech Arena, Aug 2026)**
- **Access:** API key via VUI Labs console; public pricing details are thin compared to larger providers
- **Best for:** Teams wanting a top-5 quality/latency combo outside the usual big-lab options; Chinese/English/Japanese/Korean content
- **Not ideal for:** Teams needing extensive public documentation, SLAs, or a long operating track record (still a very new provider)

## StepAudio 2.5 TTS (StepFun) — Contextual Performance TTS (NEW May 2026)

StepAudio 2.5 TTS from StepFun (Shanghai) ranked #3 on the Artificial Analysis Speech Arena at launch (Elo ~1,187, May 2026); by August 2026 it sits further down the board as Cartesia Sonic 3.6, Qwen-Audio-3.0-TTS-Plus, Speechify SIMBA 3.2, Gemini 3.1 Flash TTS, Fun-Realtime-TTS, Inworld TTS-2, and xAI Grok TTS all rank above it. The key differentiator: it is the first TTS model to integrate full contextual understanding into the generation pipeline, so it doesn't just read text, it *performs* it.
...
xAI launched its Grok Text-to-Speech API in April 2026, built on the same voice stack powering Grok Voice, Tesla vehicles, and Starlink customer support. Ranked ~#6 on the Artificial Analysis TTS Arena as of July 2026 (Elo ~1,194); as of August 2026 the top of the board is even more crowded (Cartesia Sonic 3.6, Qwen-Audio-3.0-TTS-Plus, Speechify SIMBA 3.2, Inworld Realtime TTS-2 Flash, Luna TTS all rank above it), so Grok TTS has likely drifted further down.
...
- **Not ideal for:** Budget-sensitive high-volume use (use Speechmatics $0.011/1K chars or Kokoro at no cost); theatrical emotional range (use Hume Octave 2); top-5 quality ranking (Cartesia Sonic 3.6 and several others now rank above it)
...
| Professional ad voiceover | ElevenLabs v3 or Inworld TTS-2 (TTS-1.5 is now deprecated for new projects) |
...
| Best blind-test naturalness (cloud) | Cartesia Sonic 3.6 (Elo 1,288, **#1** Aug 2026), Qwen-Audio-3.0-TTS-Plus (Elo 1,243, **#2**), Speechify SIMBA 3.2 (Elo 1,239, **#3**), Inworld Realtime TTS-2 Flash (Elo 1,226, **#4**), Luna-TTS (Elo 1,225, **#5**) |
...
| Real-time voice agent / chatbot | Cartesia Sonic 3.6 (sub-90ms TTFA, #1 quality), Inworld Realtime TTS-2 Flash (25ms TTFB), Smallest.ai Lightning V3.1 (<100ms), or Inworld Realtime TTS-2 (<200ms, closed-loop, 100+ langs) |
...
| Top quality at minimum cost | Speechify SIMBA 3.2 (**#3 globally** Aug 2026, Elo 1,239, $10/1M chars; $6/1M at Scale tier) — best price/quality; Cartesia Sonic 3.6 is now #1 (sub-90ms latency too) and Qwen-Audio-3.0-TTS-Plus is #2 but has slower throughput (16 chars/sec) |
| Conversational AI with tone/context awareness across turns | Inworld Realtime TTS-2 (closed-loop, adapts to prior audio, 100+ langs, May 2026) or TTS-2 Flash (25ms TTFB, #4 globally Aug 2026) |
| Grok/xAI ecosystem, 20+ languages, format flexibility | xAI Grok TTS ($4.20/1M chars, ~#6 globally July 2026, voice cloning — likely lower now given new Aug 2026 entrants) |
| Contextual performance TTS, dramatic delivery without tags | StepAudio 2.5 TTS (platform.stepfun.ai, Elo ~1,187, plain-language voice direction) |
| Top-5 quality/latency from a small independent lab | Luna-TTS (VUI Labs, Elo 1,225, **#5** Aug 2026, 41.6ms latency, diffusion architecture, Chinese/English/Japanese/Korean) |
...
| Highest-ranked cloud TTS by Elo, real-time streaming | Cartesia Sonic 3.6 (free tier, Elo 1,288, **#1** Aug 2026, sub-90ms latency, 44 langs); Qwen-Audio-3.0-TTS-Plus (Alibaba DashScope, Elo 1,243, **#2**); Speechify SIMBA 3.2 ($10/1M chars, Elo 1,239, **#3**); Inworld Realtime TTS-2 Flash (Elo 1,226, **#4**, 25ms TTFB) |
