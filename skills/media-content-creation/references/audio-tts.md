...
ElevenLabs previewed its next-generation v4 voice model at ElevenSummit in Warsaw (June 2026). As of September 26, 2026, v4 **remains unreleased** — no model ID, API endpoint, or release date announced. Preview samples demonstrated expressive delivery with emotion, intent, and accent — positioning it as "performance acting" rather than text-to-speech. Don't confuse this with **ElevenLabs Studio 4.0** (shipped September 21, 2026) — a separate product update to the creative-suite editor (video/image/voice/music project editor plus a "Studio Agent" co-editor), not the v4 voice model. Check elevenlabs.io/changelog for the v4 GA announcement.
...
## Gemini 3.8 Flash TTS / Flash-Lite — #2 Artificial Analysis TTS Arena, 130 Languages (NEW Sept 2026)

Google launched Gemini 3.8 Flash TTS and Gemini 3.8 Flash-Lite TTS around September 22–23, 2026, superseding the 3.1/3.5 Flash TTS line. Flash supports 130 languages with 2,000+ prepackaged voices and natural-language custom voice creation; Flash-Lite trims that to 101 languages for cheaper, latency-sensitive use (dubbing, customer-service agents). Gemini 3.8 Flash TTS ranks **#2 on the Artificial Analysis Speech Arena (Elo ~1,265)** behind Cartesia Sonic 3.6, at roughly a third of Sonic 3.6's price.

- **URL:** aistudio.google.com | Vertex AI | cloud.google.com/text-to-speech
- **Free tier:** Yes — free in Google AI Studio (rate limited)
- **Languages:** 130 (Flash) / 101 (Flash-Lite)
- **Voices:** 2,000+ prepackaged; natural-language custom voice creation
- **Elo:** ~1,265 — **#2 globally (Artificial Analysis Speech Arena, Sept 2026)**
- **Best for:** Entertainment, games, and narration (Flash); high-volume dubbing and customer-service voice agents (Flash-Lite) needing lower cost than Sonic 3.6
- **Not ideal for:** Absolute lowest latency (Cartesia Sonic 3.6 still leads on quality+speed combined)

## Gemini 3.1 Flash TTS — Free, 70+ Languages, Style-Controllable (superseded by 3.8, Apr 2026)
...
Cartesia Sonic 3.6 (released August 27, 2026) is purpose-built for real-time conversational AI with ~40ms time-to-first-audio — the standard pick for voice agents and chatbots. It **took #1 on the Artificial Analysis Speech Arena** (Elo ~1,277–1,279), displacing Qwen-Audio-3.0-TTS-Plus and Speechify SIMBA 3.2, and now leads both the provider and controlled-voice streaming arenas. In blind listening tests, listeners preferred Sonic 3.6 over Sonic 3.5 up to 93% of the time, and over ElevenLabs Eleven v3 92% of the time in US English. The upgrade applies automatically to all existing Cartesia integrations.

- URL: cartesia.ai
- Free tier available
- Latency: ~40ms TTFA (best-in-class for streaming)
- Languages: 42
- Elo: ~1,277–1,279 — **#1 globally (Artificial Analysis Speech Arena, Aug–Sep 2026)**
- Best for: voice agents, live chatbots, real-time assistants — now #1 on quality benchmarks as well as latency
...
Alibaba's Qwen-Audio-3.0-TTS-Plus (distinct from the open-source Qwen3-TTS listed below) briefly held **#1 on the Artificial Analysis Speech Arena Leaderboard** in mid-July 2026, narrowly surpassing Speechify SIMBA 3.2. **Since surpassed** by Cartesia Sonic 3.6 (Aug 27, 2026, Elo ~1,277) and Gemini 3.8 Flash TTS (Sept 2026, Elo ~1,265) — now sits outside the top 2. Delivers increased naturalness and contextually appropriate intonation; available as a proprietary cloud-hosted model via Alibaba Cloud Model Studio (DashScope). Continues Alibaba's momentum across model categories following HappyHorse and Fun-Realtime-TTS.

- **URL:** alibabacloud.com (Model Studio / DashScope)
- **Elo:** 1,236 — held **#1 globally** mid-July 2026; **surpassed by Cartesia Sonic 3.6 and Gemini 3.8 Flash TTS as of Sept 2026**
...
Speechify SIMBA 3.2 (July 2026) reached **#1 on the Artificial Analysis TTS Arena** before being narrowly surpassed by Qwen-Audio-3.0-TTS-Plus in mid-July 2026, and has since dropped further as Cartesia Sonic 3.6 and Gemini 3.8 Flash TTS took #1 and #2 in Aug–Sept 2026 — at $10/1M characters ($6/1M at the Scale tier), it remains the lowest price among the historical global top-5 models. SIMBA 3.0 (May 2026) entered at #7 (Elo 1,159); 3.2 improved emotional control, locale coverage, and streaming latency, rising to #1 by mid-July 2026 before newer models overtook it.
