...
ElevenLabs previewed its next-generation v4 voice model at ElevenSummit in Warsaw (June 2026). As of September 2026, v4 still has **not been released** — no model ID, API endpoint, or confirmed release date; unofficial roadmap chatter points to H2 2026, but that is not an ElevenLabs commitment. Preview samples demonstrated expressive delivery with emotion, intent, and accent — positioning it as "performance acting" rather than text-to-speech. Check elevenlabs.io/changelog for the GA announcement.
...
## Inworld Realtime TTS-2 — Closed-Loop Conversational TTS

Inworld Realtime TTS-2 (launched May 5, 2026) is a fundamentally different architecture from TTS-1.5: it takes the actual audio of prior conversation turns as input — not just text — so it understands tone, pacing, and emotional context from everything that was said before. It has since climbed to **#2–#3 on the Artificial Analysis Speech Arena** (Elo ~1,243–1,252, September 2026, just behind Cartesia Sonic 3.6), and Artificial Analysis ranks it **#1** on its separate Controlled Voice Arena (which clones every model onto identical reference voices to isolate engine quality from voice-talent quality) — up from #4 (Elo ~1,203) in July 2026.
...
Inworld TTS-1.5 Max held #1 on the Artificial Analysis Speech Arena in July 2026 before Speechify SIMBA 3.2 surpassed it, then Qwen-Audio-3.0-TTS-Plus, and by September 2026 Cartesia Sonic 3.6 and stablemate Inworld Realtime TTS-2 have pushed it further down the board. Wins blind tests for naturalness, emotional range, and conversational flow at sub-200ms streaming latency. Realtime TTS-2 (above) is now the pick for real-time conversational use and also leads on quality; TTS-1.5 Max remains a solid pick for non-conversational voiceover production.

- URL: inworld.ai
- Free tier: 40 minutes/month
- Latency: <200ms streaming
- **Elo: 1,238 (peak, early July 2026)** — surpassed by Speechify SIMBA 3.2, then Qwen-Audio-3.0-TTS-Plus, then Cartesia Sonic 3.6 and Inworld Realtime TTS-2 by September 2026; live leaderboard rankings shift dynamically
...
Google's Gemini 3.1 Flash TTS (launched April 15, 2026) delivers natural, expressive speech with inline audio tags for style and pacing control — and is currently free in AI Studio during preview. It held #1 on the Artificial Analysis TTS Arena through May 2026 and was briefly #2 in June 2026 when Alibaba's Fun-Realtime-TTS surpassed it; by September 2026 it has fallen further out of the top 5 as Cartesia Sonic 3.6, Inworld Realtime TTS-2, Qwen-Audio-3.0-TTS-Plus, and Speechify SIMBA 3.2 all now rank above it — still the strongest **free** option among top-ranked models.
...
- **Elo:** ~1,217 on Artificial Analysis TTS Arena — held #1 through May 2026; by September 2026 outside the top 5 as Cartesia Sonic 3.6, Inworld Realtime TTS-2, Qwen-Audio-3.0-TTS-Plus, and Speechify SIMBA 3.2 all rank above it, though still the top **free** option
...
Cartesia Sonic 3.6 (released August 27, 2026, three months after Sonic 3.5) reclaimed the #1 spot on the Artificial Analysis Speech Arena — listeners preferred it over Sonic 3.5 in up to 93% of blind head-to-head tests across 15 locales. It's still purpose-built for real-time conversational AI and remains the standard pick for voice agents and chatbots, now runs on state-space models rather than transformers, and adds full support for 44 languages. The upgrade applies automatically to all existing Cartesia integrations.

- URL: cartesia.ai
- Free tier available
- Latency: sub-90ms TTFA (streaming)
- Languages: 44
- Elo: ~1,277–1,283 — **#1 globally (Artificial Analysis Speech Arena, September 2026)**; Inworld Realtime TTS-2 and Qwen-Audio-3.0-TTS-Plus are close behind for #2/#3 — live leaderboard rankings shift dynamically
- Best for: voice agents, live chatbots, real-time assistants — now leads on quality benchmarks as well as latency
...
## Qwen-Audio-3.0-TTS-Plus (Alibaba) — Top-3 Artificial Analysis TTS Arena (Elo ~1,241–1,260, September 2026)

Alibaba's Qwen-Audio-3.0-TTS-Plus (distinct from the open-source Qwen3-TTS listed below) held **#1 on the Artificial Analysis Speech Arena Leaderboard** in mid-July 2026, narrowly surpassing Speechify SIMBA 3.2. By September 2026 it sits in a tight **#2–#3** cluster with Inworld Realtime TTS-2, both behind new leader Cartesia Sonic 3.6. Delivers increased naturalness and contextually appropriate intonation; available as a proprietary cloud-hosted model via Alibaba Cloud Model Studio (DashScope). Continues Alibaba's momentum across model categories following HappyHorse and Fun-Realtime-TTS.

- **URL:** alibabacloud.com (Model Studio / DashScope)
- **Elo:** ~1,241–1,260 — **top-3 globally (Artificial Analysis Speech Arena, September 2026)**; held #1 briefly at Elo 1,236 in mid-July 2026 before Cartesia Sonic 3.6 and Inworld Realtime TTS-2 overtook it; live leaderboard rankings shift dynamically
...
## Speechify SIMBA 3.2 — Top-4 Artificial Analysis TTS Arena at $10/1M Characters (September 2026)

Speechify SIMBA 3.2 (July 2026) briefly reached **#1 on the Artificial Analysis TTS Arena** before being narrowly surpassed by Qwen-Audio-3.0-TTS-Plus, and by September 2026 it sits **#4** (Elo ~1,238) as Cartesia Sonic 3.6 and Inworld Realtime TTS-2 also overtook it — still at $10/1M characters ($6/1M at the Scale tier), the lowest price among the current global top-5 models. SIMBA 3.0 (May 2026) entered at #7 (Elo 1,159); 3.2 improved emotional control, locale coverage, and streaming latency, rising to #1 by mid-July 2026 before newer models leapfrogged it.
...
- **Best for:** Cost-sensitive high-volume production TTS needing top-tier quality; enterprises benchmarking ElevenLabs alternatives at 10× lower price
...
| Best blind-test naturalness (cloud) | Cartesia Sonic 3.6 (Elo ~1,280, **#1**, September 2026), Inworld Realtime TTS-2 / Qwen-Audio-3.0-TTS-Plus (Elo ~1,241–1,252, **#2/#3**), Speechify SIMBA 3.2 (Elo ~1,238, **#4**) |
...
| Real-time voice agent / chatbot | Cartesia Sonic 3.6 (sub-90ms TTFA, now **#1** on quality too), Smallest.ai Lightning V3.1 (<100ms), or Inworld Realtime TTS-2 (<200ms, closed-loop, 100+ langs, **#1** Controlled Voice Arena) |
...
| Top quality at minimum cost | Speechify SIMBA 3.2 (top-4 globally, Elo ~1,238, $10/1M chars; $6/1M at Scale tier) — best price/quality; Cartesia Sonic 3.6, Inworld Realtime TTS-2, and Qwen-Audio-3.0-TTS-Plus rank higher but cost more or (for Qwen-Audio) have slower throughput (16 chars/sec) |
| Conversational AI with tone/context awareness across turns | Inworld Realtime TTS-2 (closed-loop, adapts to prior audio, 100+ langs, **#1** Controlled Voice Arena / top-3 overall as of September 2026) |
...
| Highest-ranked cloud TTS by Elo, real-time streaming | Cartesia Sonic 3.6 (free tier, Elo ~1,280, **#1**, sub-90ms latency, September 2026); Inworld Realtime TTS-2 (Elo ~1,243–1,252, **#2/#3**, closed-loop conversational); Qwen-Audio-3.0-TTS-Plus (Alibaba DashScope, Elo ~1,241–1,260, **#2/#3**); Speechify SIMBA 3.2 ($10/1M chars, Elo ~1,238, **#4**) |
