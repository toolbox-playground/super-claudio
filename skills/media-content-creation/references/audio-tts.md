...
## Cartesia Sonic 3.6 — NEW #1 Artificial Analysis Speech Arena (August 2026)

Cartesia Sonic 3.6 shipped ~August 18, 2026 and reclaimed **#1 on both the Provider Voice and Controlled Voice Artificial Analysis Speech Arena leaderboards**, surpassing Speechify SIMBA 3.2 and Alibaba's Qwen-Audio-3.0-TTS-Plus (which had been essentially tied at the top). Like Sonic 3/3.5 it runs on a state-space-model (SSM) architecture rather than transformers — the source of its low latency. Adds ~10-second instant voice cloning and inline expression tags (e.g. `[laughter]`). Sonic 3.5 remains available (still the documented stable default on Cartesia's API as of August 2026) and now sits at #2 on the Controlled Voice arena behind 3.6.

- URL: cartesia.ai
- Free tier available (Sonic 3.5); Sonic 3.6 accessible via the same API (beta)
- Latency: vendor-stated sub-90ms TTFA (ideal conditions); real-world measured ~166–190ms
- Languages: 42
- Elo: ~1,283–1,286 on Artificial Analysis Speech Arena (Provider Voice) — **#1 globally (August 2026)**, ahead of Speechify SIMBA 3.2 (~1,238) and Qwen-Audio-3.0-TTS-Plus (~1,237)
- Pricing: $49/1M characters (check cartesia.ai/pricing for current tiers — Sonic 3.5 pricing is lower)
- Best for: voice agents, live chatbots, real-time assistants needing both fast latency and the current top quality benchmark
- Not ideal for: long-form content where ElevenLabs, Fish Audio, or Chatterbox are better; budget-sensitive pipelines (SIMBA 3.2 is far cheaper at $10/1M chars for near-identical quality)
...
## Qwen-Audio-3.0-TTS-Plus (Alibaba) — #2/#3 Artificial Analysis TTS Arena (Elo ~1,237, August 2026)

Alibaba's Qwen-Audio-3.0-TTS-Plus (distinct from the open-source Qwen3-TTS listed below) briefly held **#1 on the Artificial Analysis Speech Arena Leaderboard** in mid-July 2026, narrowly ahead of Speechify SIMBA 3.2. As of August 2026 it has been surpassed by Cartesia Sonic 3.6 (new #1, Elo ~1,286) and sits essentially tied with SIMBA 3.2 for #2/#3 (overlapping confidence intervals). Delivers increased naturalness and contextually appropriate intonation; available as a proprietary cloud-hosted model via Alibaba Cloud Model Studio (DashScope). Continues Alibaba's momentum across model categories following HappyHorse and Fun-Realtime-TTS.

- **URL:** alibabacloud.com (Model Studio / DashScope)
- **Elo:** ~1,237 — **#2/#3 globally (Artificial Analysis Speech Arena, August 2026)**, behind Cartesia Sonic 3.6 (#1, ~1,286); essentially tied with SIMBA 3.2 (~1,238) with overlapping confidence intervals
...
## Speechify SIMBA 3.2 — #2/#3 Artificial Analysis TTS Arena at $10/1M Characters (August 2026)

Speechify SIMBA 3.2 (July 2026) briefly reached **#1 on the Artificial Analysis TTS Arena** before being narrowly surpassed by Qwen-Audio-3.0-TTS-Plus in mid-July 2026, then by Cartesia Sonic 3.6 in August 2026 (now **#2/#3, Elo ~1,238**; essentially tied with Qwen-Audio-3.0-TTS-Plus) — at $10/1M characters ($6/1M at the Scale tier), the lowest price among current global top-5 models. SIMBA 3.0 (May 2026) entered at #7 (Elo 1,159); 3.2 improved emotional control, locale coverage, and streaming latency, briefly reaching #1 in July 2026.

- **URL:** speechify.com
- **Free tier:** No API free tier; Speechify consumer app has a limited free plan
- **Pricing:** $10/1M characters; $6/1M at Scale tier — cheapest model in the global top 10 by Elo, including well below new #1 Cartesia Sonic 3.6 ($49/1M chars)
...
| Best blind-test naturalness (cloud) | Cartesia Sonic 3.6 (Elo ~1,286, **#1** August 2026), Speechify SIMBA 3.2 & Qwen-Audio-3.0-TTS-Plus (Elo ~1,238/~1,237, **#2/#3**, essentially tied), Gemini 3.1 Flash TTS (Elo ~1,214, **~#4**), Cartesia Sonic 3.5 (Elo ~1,207, **~#5**) |
...
| Real-time voice agent / chatbot | Cartesia Sonic 3.5 (~40ms TTFA, cheaper) or Sonic 3.6 (new #1 quality, beta, $49/1M chars), Smallest.ai Lightning V3.1 (<100ms), or Inworld Realtime TTS-2 (<200ms, closed-loop, 100+ langs) |
...
| Top quality at minimum cost | Speechify SIMBA 3.2 (**#2/#3 globally** August 2026, Elo ~1,238, $10/1M chars; $6/1M at Scale tier) — best price/quality by far; new #1 Cartesia Sonic 3.6 costs $49/1M chars and Qwen-Audio-3.0-TTS-Plus has slower throughput (16 chars/sec) |
...
| Highest-ranked cloud TTS by Elo, real-time streaming | Cartesia Sonic 3.6 (cartesia.ai, Elo ~1,286, **#1** August 2026, $49/1M chars); Speechify SIMBA 3.2 & Qwen-Audio-3.0-TTS-Plus (Elo ~1,238/~1,237, **#2/#3**); Gemini 3.1 Flash TTS (free in AI Studio, Elo ~1,214, ~#4); Cartesia Sonic 3.5 (free tier, Elo ~1,207, ~#5, ~40ms latency) |
