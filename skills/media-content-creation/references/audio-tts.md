...
- **Also available:** Gemini 3.5 Flash TTS (June 2026) — same API, $6/1M output tokens (70% cheaper than 3.1; feature parity being confirmed); **Gemini 3.8 Flash TTS** (NEW, plus a Flash-Lite TTS variant) supersedes 3.1/3.5 as Google's flagship TTS, adding 2,000+ preset voices and acting/dialect controls — exact Elo ranking not yet confirmed
...
Cartesia Sonic 3.6 (shipped ~August 18, 2026) took the #1 spot on the Artificial Analysis Speech Arena, dethroning Qwen-Audio-3.0-TTS-Plus (Elo ≈1,277–1,279 per corroborating sources, vs. Qwen's prior 1,236 lead — exact live rank order below #1 shifts day to day, so treat anything past #1 as approximate). Adds 2 languages (Odia, Urdu) for 44 total, roughly doubles throughput vs. Sonic 3 Conversational (~132 chars/sec), and improves stability and pronunciation over Sonic 3.5. The upgrade applies automatically to all existing Cartesia integrations.

- URL: cartesia.ai
- Free tier: 20,000 credits/month
- Latency: <90ms TTFA
- Languages: 44 (added Odia, Urdu)
- Throughput: ~132 chars/sec (~2× Sonic 3 Conversational)
- Elo: ≈1,277–1,279 — **#1 globally (Artificial Analysis Speech Arena, Aug 2026)**
...
## Qwen-Audio-3.0-TTS-Plus (Alibaba) — Formerly #1 Artificial Analysis TTS Arena, Now Surpassed (Elo 1,236)

Alibaba's Qwen-Audio-3.0-TTS-Plus (distinct from the open-source Qwen3-TTS listed below) held **#1 on the Artificial Analysis Speech Arena Leaderboard** from mid-July 2026 until Cartesia Sonic 3.6 overtook it in August 2026 (Elo ≈1,277–1,279). Delivers increased naturalness and contextually appropriate intonation; available as a proprietary cloud-hosted model via Alibaba Cloud Model Studio (DashScope). Continues Alibaba's momentum across model categories following HappyHorse and Fun-Realtime-TTS.

- **URL:** alibabacloud.com (Model Studio / DashScope)
- **Elo:** 1,236 — **formerly #1 (mid-Jul–Aug 2026), now behind Cartesia Sonic 3.6**; still competitive with SIMBA 3.2 (1,234)
...
| Best blind-test naturalness (cloud) | Cartesia Sonic 3.6 (Elo ≈1,277–1,279, **#1** Aug 2026), then Qwen-Audio-3.0-TTS-Plus and Speechify SIMBA 3.2 close behind (Elo ~1,234–1,236) — exact order below #1 shifts day to day |
...
| Real-time voice agent / chatbot | Cartesia Sonic 3.6 (<90ms TTFA, now #1 overall), Smallest.ai Lightning V3.1 (<100ms), or Inworld Realtime TTS-2 (<200ms, closed-loop, 100+ langs) |
...
| Top quality at minimum cost | Speechify SIMBA 3.2 (Elo 1,234, $10/1M chars; $6/1M at Scale tier) — best price/quality among top-5; Cartesia Sonic 3.6 now leads on raw quality (#1, Elo ≈1,278) with a free tier and low latency |
...
| Highest-ranked cloud TTS by Elo, real-time streaming | Cartesia Sonic 3.6 (free tier, Elo ≈1,278, **#1** Aug 2026, <90ms latency); Qwen-Audio-3.0-TTS-Plus (Alibaba DashScope, Elo 1,236, formerly #1); Speechify SIMBA 3.2 ($10/1M chars, Elo 1,234); Gemini 3.1/3.8 Flash TTS (free in AI Studio) |
