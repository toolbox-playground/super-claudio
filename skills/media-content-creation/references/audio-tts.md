...
## Inworld AI TTS-1.5 Max — Non-Conversational Voiceover Pick (peaked #1, July 2026)

Inworld TTS-1.5 Max briefly held #1 on the Artificial Analysis Speech Arena in early July 2026 (Elo 1,238) before Speechify SIMBA 3.2, then Qwen-Audio-3.0-TTS-Plus, then Cartesia Sonic 3.6 and Inworld's own Realtime TTS-2 all moved ahead of it — as of September 2026 it's no longer top-5 by Elo, but still wins blind tests for naturalness, emotional range, and conversational flow at sub-200ms streaming latency. TTS-2 (above) is the pick for real-time conversational use; TTS-1.5 Max remains a strong pick for non-conversational voiceover production.

- URL: inworld.ai
- Free tier: 40 minutes/month
- Latency: <200ms streaming
- **Elo: 1,238 (peak, early July 2026)** — since surpassed by Speechify SIMBA 3.2, Qwen-Audio-3.0-TTS-Plus, Cartesia Sonic 3.6, and Inworld Realtime TTS-2; live leaderboard rankings shift dynamically
...
Google's Gemini 3.1 Flash TTS (launched April 15, 2026) delivers natural, expressive speech with inline audio tags for style and pacing control — and is currently free in AI Studio during preview. It held #1 on the Artificial Analysis TTS Arena through May 2026, then was passed successively by Fun-Realtime-TTS, Inworld TTS-1.5 Max, Speechify SIMBA 3.2, Qwen-Audio-3.0-TTS-Plus, Cartesia Sonic 3.6, and Inworld Realtime TTS-2 — as of September 2026 it's fallen out of the top 5, though still a strong **free** option for multilingual, style-directed narration.
...
- **Elo:** ~1,217 (as of July 2026) on Artificial Analysis TTS Arena — held #1 through May 2026; no longer top-5 as of September 2026 (see Cartesia Sonic 3.6, Qwen-Audio-3.0-TTS-Plus, Inworld Realtime TTS-2, Speechify SIMBA 3.2 above)
...
## Cartesia Sonic 3.6 — #1 Artificial Analysis TTS Arena, Real-Time Conversational TTS (Aug 2026)

Cartesia Sonic 3.6 (shipped August 2026) took **#1 on the Artificial Analysis Speech Arena**, unseating Qwen-Audio-3.0-TTS-Plus — the first time Cartesia has led the leaderboard outright rather than winning on latency alone. It adds 15 languages/locales over Sonic 3.5 (now 44 languages / 61 locales, including Odia, Urdu, and Hinglish) and generates roughly 2× faster than Sonic 3 Conversational (~132 chars/sec vs ~68). Vendor-quoted latency is sub-90ms TTFA; independent real-world measurements report ~166–190ms, still fast but not the ~40ms Sonic 3.5 figure implied. The upgrade applies automatically to all existing Cartesia integrations.

- URL: cartesia.ai
- Free tier available (~27 TTS minutes on Free; Pro $5/mo ~133 min; Startup $49/mo ~1,667 min; Scale $299/mo ~10,667 min)
- Latency: sub-90ms TTFA (vendor claim); ~166–190ms in independent real-world tests
- Languages: 44 (61 locales)
- Elo: ~1,272–1,283 — **#1 globally (Artificial Analysis Speech Arena, September 2026)**, ahead of Qwen-Audio-3.0-TTS-Plus
- Pricing: from $10.00/1M input tokens (API)
- Best for: voice agents, live chatbots, real-time assistants — now the top-ranked model on both latency and quality benchmarks
...
- **Not ideal for:** Ultra-low-latency agents (use Cartesia Sonic 3.6, sub-90ms vendor TTFA); high-throughput batch generation (use SIMBA 3.2 or Kokoro); offline/on-device deployment (use NeuTTS Air)

## Speechify SIMBA 3.2 — Cheapest Top-5 Model, ~#4 Artificial Analysis TTS Arena (September 2026)

Speechify SIMBA 3.2 (July 2026) briefly reached #1 on the Artificial Analysis TTS Arena in mid-July 2026 before being passed by Qwen-Audio-3.0-TTS-Plus, then by Cartesia Sonic 3.6 (August) and Inworld Realtime TTS-2 — it now sits **~#4 (Elo ~1,237–1,241)**. At $10/1M characters ($6/1M at the Scale tier), it remains the lowest price among the current global top-5 models by a wide margin. SIMBA 3.0 (May 2026) entered at #7 (Elo 1,159); 3.2 improved emotional control, locale coverage, and streaming latency.
...
- **Not ideal for:** Budget-sensitive high-volume use (use Speechmatics $0.011/1K chars or Kokoro at no cost); theatrical emotional range (use Hume Octave 2); top-5 quality ranking (Cartesia Sonic 3.6, Qwen-Audio-3.0-TTS-Plus, Inworld Realtime TTS-2, and Speechify SIMBA 3.2 all rank above it as of September 2026)
...
| Best blind-test naturalness (cloud) | Cartesia Sonic 3.6 (Elo ~1,272–1,283, **#1**, Sept 2026), Qwen-Audio-3.0-TTS-Plus (Elo ~1,259, **#2**), Inworld Realtime TTS-2 (Elo ~1,246, **#3**), Speechify SIMBA 3.2 (Elo ~1,238, **#4**) |
...
| Real-time voice agent / chatbot | Cartesia Sonic 3.6 (sub-90ms vendor TTFA, #1 overall), Smallest.ai Lightning V3.1 (<100ms), or Inworld Realtime TTS-2 (<200ms, closed-loop, 100+ langs) |
...
| Top quality at minimum cost | Speechify SIMBA 3.2 (**~#4 globally**, Sept 2026, Elo ~1,238, $10/1M chars; $6/1M at Scale tier) — best price/quality in the top 5; Cartesia Sonic 3.6 and Qwen-Audio-3.0-TTS-Plus rank higher but cost more |
...
| Highest-ranked cloud TTS by Elo, real-time streaming | Cartesia Sonic 3.6 (free tier, Elo ~1,272–1,283, **#1**, Sept 2026, sub-90ms vendor latency); Qwen-Audio-3.0-TTS-Plus (Alibaba DashScope, Elo ~1,259, **#2**); Inworld Realtime TTS-2 (Elo ~1,246, **#3**); Speechify SIMBA 3.2 ($10/1M chars, Elo ~1,238, **#4**) |
