...
- **Elo:** ~1,208 on Artificial Analysis Speech Arena — **#3 globally (July 2026)**; held #1 briefly in June 2026 (Elo 1,219) before Gemini 3.1 Flash TTS and Cartesia Sonic 3.6 surpassed it
...
## Cartesia Sonic 3.6 — #1 on Both Artificial Analysis Speech Arenas, Real-Time Conversational TTS

Cartesia Sonic 3.6 (GA Aug 27, 2026) is purpose-built for real-time conversational AI with ~40ms time-to-first-audio — the standard pick for voice agents and chatbots. It's the first model to simultaneously lead both Artificial Analysis speech leaderboards (Provider Voice Elo 1,282; Controlled Voice Elo 1,123) — listeners preferred it in up to 93% of blind head-to-head tests vs. Sonic 3.5 across fifteen locales. Adds Odia and Urdu, bringing total language coverage to 44. The upgrade applies automatically to all existing Cartesia integrations.

- URL: cartesia.ai
- Free tier: ~20,000 credits/month (~27 min)
...
StepAudio 2.5 TTS from StepFun (Shanghai) ranked #3 on the Artificial Analysis Speech Arena at launch (Elo ~1,187, May 2026); by July 2026 it sits ~#7 as Gemini 3.1 Flash TTS, Cartesia Sonic 3.6, Fun-Realtime-TTS, Inworld TTS-2, Inworld TTS-1.5 Max, and xAI Grok TTS all rank above it. The key differentiator: it is the first TTS model to integrate full contextual understanding into the generation pipeline, so it doesn't just read text, it *performs* it.
...
xAI launched its Grok Text-to-Speech API in April 2026, built on the same voice stack powering Grok Voice, Tesla vehicles, and Starlink customer support. Ranked ~#6 on the Artificial Analysis TTS Arena (Elo ~1,194, July 2026; was #5 in June 2026 — Cartesia Sonic 3.6 rose above it).
...
| Best blind-test naturalness (cloud) | Cartesia Sonic 3.6 (**#1** on both Artificial Analysis speech arenas since Aug 27, 2026 — Provider Voice Elo 1,282, Controlled Voice Elo 1,123), then Qwen-Audio-3.0-TTS-Plus (Elo 1,236, mid-July 2026), Speechify SIMBA 3.2 (Elo 1,234), Gemini 3.1 Flash TTS (Elo ~1,214) |
...
| Real-time voice agent / chatbot | Cartesia Sonic 3.6 (~40ms TTFA), Smallest.ai Lightning V3.1 (<100ms), or Inworld Realtime TTS-2 (<200ms, closed-loop, 100+ langs) |
...
| Highest-ranked cloud TTS by Elo, real-time streaming | Cartesia Sonic 3.6 (free tier, **#1** on both Artificial Analysis arenas since Aug 27, 2026, ~40ms latency); Qwen-Audio-3.0-TTS-Plus (Alibaba DashScope, Elo 1,236, mid-July 2026); Speechify SIMBA 3.2 ($10/1M chars, Elo 1,234); Gemini 3.1 Flash TTS (free in AI Studio, Elo ~1,214) |
