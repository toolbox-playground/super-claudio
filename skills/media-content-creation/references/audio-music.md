...
- URL: suno.com
- **Latest model:** v6 (launched September 9, 2026) — three-tier lineup: v6 flagship + v6-wild (Pro/Premier), v6-mini (free for all users); trained on music licensed from Warner Music Group, BMG, and Believe/TuneCore (deals signed Nov 2025–Sep 2026); replaces the older v5.5 and earlier unlicensed-data models entirely
- **Litigation note:** the licensed-model transition (previously "pending") is now complete for Warner/BMG/Believe catalogs, but Sony Music and UMG did **not** settle — they filed a new suit against Suno on September 18, 2026, alleging v6 was trained on outputs of the older unlicensed models. Treat Suno's licensing status as unresolved with two of the three major labels.
...
- **Model retirement (completed Sep 9, 2026):** Following the November 2025 settlement with Warner Music Group (and subsequent BMG/Believe deals), Suno retired its unlicensed-data models and launched the licensed v6 lineup. Generations made with the old models remain accessible for now, but users who want to preserve them should download on a paid plan. UMG and Sony Music did not settle — Sony filed a new suit on September 18, 2026 alleging v6 itself was trained on outputs of the old unlicensed models; litigation risk is not resolved.
