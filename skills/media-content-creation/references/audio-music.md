...
- **Model retirement (pending 2026):** Following a November 2025 settlement with Warner Music Group, Suno committed to retiring all current models (trained on unlicensed audio) once new licensed-catalog models launch. As of August 2026 the transition has not yet occurred — current models remain active — but when it does, all generations made with the old models will eventually become inaccessible. UMG and Sony Music litigation remains active — the U.S. fair-use summary judgment hearing (originally set for July 2026) has slipped to Q4 2026 with no verdict yet; the German case (GEMA v. Suno), heard July 31, 2026, produced a partial ruling in early August 2026 finding Suno liable for reproduction-right infringement on GEMA's catalog and ordering both sides into licensing negotiations — Suno has appealed. Users who want to preserve old generations should download them now on a paid plan.
