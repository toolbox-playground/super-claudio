...
- **Model retirement (in progress, confirmed Aug 2026):** Following the November 2025 Warner Music Group settlement, Suno announced its next-generation v6 models on Aug 10, 2026, built on licensed catalogs from Warner, BMG, and Believe. Unlicensed prior models — including v5.5 — are being retired as v6 rolls out; generations made with old models will eventually become inaccessible. Users who want to preserve old generations should download them now on a paid plan.
- **UMG/Sony litigation (US):** The fair-use summary judgment ruling has been pushed back to Jan 8, 2027 (fact discovery closes Sept 30, 2026) — still unresolved, no verdict.
- **GEMA v. Suno (Germany):** Munich Regional Court I ruled against Suno on July 31, 2026, setting a €250,000 penalty per breach — the first ruling anywhere against a generative-AI music tool.
