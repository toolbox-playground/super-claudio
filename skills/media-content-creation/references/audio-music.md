...
- **Model retirement (pending 2026):** Following a November 2025 settlement with Warner Music Group, Suno committed to retiring all current models (trained on unlicensed audio) once new licensed-catalog models launch. As of August 2026 the transition has not yet occurred — current models remain active — but when it does, all generations made with the old models will eventually become inaccessible. CEO Robert Kyncl has reaffirmed the licensed model is still planned for "later this year." Users who want to preserve old generations should download them now on a paid plan.
- **GEMA v. Suno ruling (July 31, 2026):** The Munich Regional Court ruled against Suno in the first European court decision on a generative-AI music tool — prohibiting US-side training reproduction, in-Germany "memorisation" reproduction, and making the model/outputs available to the public for 6 test compositions; ordered Suno to disclose revenue tied to the infringing works and pay damages (amount not yet determined). The court held that training outside the EU can still infringe under German law and rejected a US fair-use defense. The judgment is not final — an appeal is expected.
- **UMG/Sony US litigation delayed:** The expected July 2026 summary-judgment ruling did not occur — per a June 30, 2026 amended scheduling order, fact discovery now runs to September 30, 2026, with dispositive motions not due until April 2027 (no ruling expected in 2026). Sony/UMG expanded their claim from 560 to 61,026 specifically identified recordings in May 2026.
- **Watermarking & download policy (announced Aug 6, 2026):** Suno said it will add tamper-resistant audio watermarking/fingerprinting to generated tracks and a new download policy restricting mass-distribution to streaming platforms (aimed at streaming-royalty-fraud bot schemes), alongside updated community guidelines banning deceptive/deepfake-voice use. Specific quotas and rollout timing not yet published.
