...
- **Download policy update (effective September 3, 2026, per Suno's own ToS/blog):** Free users who joined before Sept 3, 2026 get 7 lifetime trial downloads (personal use only, covering their entire existing library — not a monthly reset); free users joining on/after Sept 3, 2026 may occasionally receive trial downloads. Additional downloads can be purchased. Pro plan: 20 downloads/month with commercial rights; Premier: 60/month.
