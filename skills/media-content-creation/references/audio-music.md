...
- **Downloads policy (effective September 3, 2026):** Free tier gets 7 lifetime downloads (personal use only); Pro gets 20 downloads/month; Premier gets 60 downloads/month plus unlimited downloads inside Suno Studio. Applies retroactively to tracks made before the change.
