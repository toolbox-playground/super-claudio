...
- **Voices on mobile (Aug 7, 2026):** Voice cloning is now available in the Suno iOS/Android app — record or upload vocals (or pull one from your library), verify with a spoken phrase, then generate songs in that voice. Pro/Premier get unlimited use; free-tier users now get a limited trial (previously desktop + paid-only)
...
- **Model retirement (pending 2026):** Following the Warner Music Group settlement (Nov 2025), Suno committed to retiring all current models (trained on unlicensed audio) once new licensed-catalog models launch. A second major-label deal with **BMG** (Aug 12, 2026 — a global licensing alliance settling BMG's past claims, with artist/songwriter opt-in required for AI training and outputs) advances that transition and lays the groundwork for Suno's next model, developed in partnership with the music industry and expected later in 2026. As of mid-August 2026 the old models remain active, but when the switch happens, generations made with them will eventually become inaccessible.
- **GEMA ruling (July 31, 2026):** The Munich Regional Court found Suno liable for copyright infringement in the GEMA (Germany) case — ruling it trained on stream-ripped, unlicensed material and asserting German/EU jurisdiction over Suno despite it being U.S.-based (its outputs reach EU users). Suno is evaluating an appeal. In response, Suno announced (Aug 6, 2026 blog post) inaudible, tamper-resistant audio watermarking on all generations, tightened community guidelines against mass-uploaded "farm" tracks and copycat songs, and new download caps effective **Sept 3, 2026**: Pro subscribers limited to 20 downloads/month, Premier to 60/month (previously unlimited on paid plans).
- **U.S. litigation (UMG + Sony, ongoing):** The Massachusetts fair-use case remains unresolved — fact discovery closes Sept 30, 2026 and dispositive motions are due April 9, 2027, pushing a fair-use ruling to 2027 at the earliest (not July 2026 as previously expected). UMG and Sony are also seeking to add 61,000+ additional works to the suit (motion pending). Users who want to preserve old generations should download them now on a paid plan, before the new Sept 3 caps take effect.
