...
- **Litigation update (Aug 2026):** The Munich Regional Court ruled against Suno on July 31, 2026 in the GEMA (German collecting society) copyright case — finding infringement both in storing copyrighted works inside the model and in generating outputs for users; damages are still to be determined and Suno can appeal to a higher German court. This is GEMA's second AI win after OpenAI (Nov 2025). Separately, the U.S. fair-use case (UMG/Sony) has **not** reached a summary-judgment ruling as previously expected — the schedule slipped, with fact discovery now running to Sept 30, 2026 and dispositive motions due April 9, 2027.
