...
- **Download caps (effective Sept 3, 2026, replacing the prior "no downloads on free tier" policy):** Free — 7 lifetime downloads (personal use only, no streaming/commercial use); Pro — 20/month; Premier — 60/month; caps apply retroactively to previously generated songs. Suno also began embedding inaudible watermarking/fingerprinting in all output audio (Aug 6, 2026) and tightened community guidelines to ban copyrighted uploads and unauthorized voice cloning.
- **Model retirement (pending 2026):** Following a November 2025 settlement with Warner Music Group, Suno committed to retiring all current models (trained on unlicensed audio) once new licensed-catalog models launch. As of September 2026 the transition has not yet occurred — current models remain active. Litigation update: the U.S. case (UMG/Sony v. Suno) did **not** produce a July 2026 ruling as previously expected — fact discovery now runs to Sept 30, 2026, with dispositive motions in April 2027, so no U.S. verdict is expected in 2026. However, the German case **GEMA v. Suno (Munich Regional Court) ruled against Suno on July 31, 2026** — the first ruling anywhere against a generative-music tool, barring use of 6 compositions and ordering damages/disclosure. Sony separately filed a second suit against Udio (July 20, 2026, +30,117 recordings), and the AFM musicians' union sued UMG/WMG over their AI licensing settlements. Users who want to preserve old generations should download them now within the new caps on a paid plan.
