...
- **New download caps (effective September 3, 2026):** Suno is replacing unlimited paid downloads with hard monthly caps — **Free: 7 downloads total, lifetime** (not per month; no commercial rights); **Pro ($10/month): 20 downloads/month** with commercial rights; **Premier ($30/month): 60 downloads/month**. Premier subscribers using Suno Studio are exempt from the cap. Limits apply retroactively to your whole library, including songs made before September 3 — streaming/sharing on-platform stays unlimited on every tier, only file export is capped. Extra downloads beyond the cap can be purchased separately. Users needing to archive a large back catalog should export before September 3.
- **Voices on mobile (Aug 7, 2026):** The Voices feature (record your own singing voice, reuse it across generations) rolled out to the iOS and Android apps, including a limited version for free-tier users — previously web/paid-only since its March 2026 debut with v5.5.
- **Watermarking:** Suno announced (early Aug 2026) it is rolling out audio watermarking and fingerprinting on generated tracks to help platforms detect AI-generated content and combat fraud/mass-distribution abuse.
- **Licensing & litigation (updated Aug 2026):** Suno signed a global licensing deal with BMG on August 12, 2026 — the first major rightsholder deal since the November 2025 Warner Music Group settlement, covering BMG's recorded and publishing catalog ahead of Suno's first label-backed model. UMG and Sony Music remain in active U.S. litigation (fair-use summary judgment still pending as of late August 2026, seeking to cover 61,000+ recordings). Separately, Germany's Munich Regional Court ruled **against** Suno in the GEMA case on July 31, 2026 — prohibiting use of six compositions in training/output, ordering damages and disclosure of usage scale, immediately enforceable under German law. The prior "current models will eventually be retired" commitment to Warner has still not taken effect as of late August 2026.
