...
- URL: suno.com
- **Latest models:** v6, v6-wild, and v6-mini (launched Sept 9, 2026) — Suno's first models built on **licensed** catalogs from Warner Music Group, BMG, and Believe/TuneCore, resolving the prior unlicensed-training dispute; v6-mini is free for all users, v6 and v6-wild require Pro/Premier. Adds plain-language editing of a single section or lyric, mashups from several songs, and inputs from text, audio, images, or video. Old models (v4–v5.5) were retired from new generations on Sept 9, 2026 — existing songs stay playable.
...
- **Downloads (2026):** Free-tier users cannot download audio files — tracks can only be streamed/shared within the platform. Paid plans now have monthly download caps effective Sept 3, 2026: Pro capped at 20 downloads/month, Premier at 60/month, no rollover.
...
Mureka is the go-to for developers and technical producers: native API, stem separation, and MIDI export alongside full song generation. Updated to V9 (March 2026) and V9.5 (Aug 31, 2026) — richer emotional depth, more cohesive arrangements, better multilingual vocals; a "test-time scaling" O3 model is in preview.
...
## MiniMax Music 3.0 — Structural Control + Studio-Grade Fidelity

MiniMax Music (originally 2.5, Jan 2026) added paragraph-level precision control over song structure and fixed the "muddy mixing" artifact common in AI music through improved spectral separation between vocals and instrumentation. Updated to 2.6 (Apr 10, 2026 — AI Cover, Lyrics Optimizer) and **3.0** (announced Aug 13, 2026 — songs up to 5 minutes, improved long-range structural consistency).

- URL: minimax.io/audio | API: wavespeed.ai/models/minimax/music
...
- **Audio fidelity:** Optimized soundstage keeps vocals and instruments in separate spectral regions
- Best for: generation where song structure matters (commercial jingles, video scoring with section-to-cut sync, multi-verse songs with distinct parts), and now longer-form tracks (up to 5 min)
- Not ideal for: stem export or MIDI (use Mureka); on-demand free generation (use Suno free tier)
...
| Need API / stems / MIDI (Mureka V9.5) | Budget is zero |
