...
- **Model retirement (pending 2026):** Following a November 2025 settlement with Warner Music Group, Suno committed to retiring all current models (trained on unlicensed audio) once new licensed-catalog models launch. As of August 2026 the transition has not yet occurred — current models remain active — but when it does, all generations made with the old models will eventually become inaccessible. **GEMA v. Suno (Germany): Suno lost** — Munich Regional Court ruled July 31, 2026 that Suno infringed GEMA's repertoire in both training and output, ordered it to stop the infringing use, disclose information, and pay damages; Suno can appeal, and the ruling asserts EU jurisdiction over Suno's US-based training since outputs reach EU users. **UMG/Sony (US):** still no verdict — the Massachusetts court's June 30, 2026 scheduling order pushed dispositive motions to April 9, 2027 (the earlier July 2026 hearing did not produce a ruling); UMG and Sony added 61,026 more recordings to the suit in May 2026 after audio fingerprinting found "millions" of their tracks in Suno's training data. Users who want to preserve old generations should download them now on a paid plan.
