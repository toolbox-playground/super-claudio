...
- **Download caps (effective September 3, 2026):** Suno is replacing unlimited paid-tier downloads with hard caps to curb bulk/bot abuse. Free tier: 7 downloads **total, lifetime** (not monthly) — personal use only, no commercial rights, can't upload to streaming. Pro ($10/month): 20 downloads/month with commercial license. Premier ($30/month): 60 downloads/month — but downloads from Suno Studio remain unlimited for Premier/Studio users. Streaming and sharing on-platform stay unlimited on every plan, including free. This is a change from the prior policy of no downloads at all on free — free users now get a small lifetime allotment.
- **Model retirement (pending 2026):** Following a November 2025 settlement with Warner Music Group, Suno committed to retiring all current models (trained on unlicensed audio) once new licensed-catalog models launch. As of August 2026 the transition has not yet occurred — current models remain active — but when it does, all generations made with the old models will eventually become inaccessible. **U.S. litigation (UMG/Sony):** no fair-use ruling has issued as of August 2026 — fact discovery closes September 30, 2026, with summary-judgment motions on fair use due April 9, 2027 (a ruling is not expected before then). **Germany (GEMA v. Suno):** GEMA won its case against Suno at the Munich Regional Court on July 31, 2026 — the court found Suno liable under both US and German copyright law for training-data reproduction and infringing outputs, ordered disclosure of usage scale and damages; the ruling is not final and Suno is expected to appeal. Users who want to preserve old generations should download them now, before the new caps take effect Sept 3, 2026.
