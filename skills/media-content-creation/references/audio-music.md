...
- **Model retirement (pending) / litigation & licensing (updated Aug 2026):** Following a November 2025 settlement with Warner Music Group, Suno committed to retiring all current models (trained on unlicensed audio) once new licensed-catalog models launch; v5.5 remains current with no confirmed name or date yet for the next licensed model. **GEMA v. Suno (Germany) — resolved against Suno:** the Munich Regional Court ruled July 31, 2026 that Suno is liable for training/reproduction/communication-to-public infringement on 6 compositions tied to GEMA's catalog, ordered to disclose usage scale and pay damages; the ruling is not final and an appeal is expected. **UMG/Sony v. Suno (US) — still active, no near-term verdict:** a June 30, 2026 amended scheduling order pushed fact discovery to Sept 30, 2026 and dispositive motions to April 9, 2027 — the fair-use ruling once expected in summer 2026 will not land for months. **New: Suno–BMG licensing deal (Aug 12, 2026)** — Suno's second major-label deal after Warner, covering global recorded + publishing rights with opt-in required for BMG artists/songwriters, plus a Suno commitment to adopt audio watermarking/fingerprinting; UMG and Sony remain unsettled. Users who want to preserve old generations should download them now on a paid plan.
