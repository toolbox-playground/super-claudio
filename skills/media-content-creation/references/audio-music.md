...
- **Watermarking & new download limits (announced Aug 6, 2026):** CEO Mikey Shulman announced Suno will embed invisible, tamper-resistant watermarks and audio fingerprints into every generated track (does not audibly degrade quality) so platforms can detect and label Suno-made content or block it outright. New download limits — details still being finalized — aim to curb mass distribution of AI songs onto streaming services while preserving normal creative/personal use. Suno is also partnering with Audible Magic and Musixmatch to screen uploaded audio/lyrics for rights and impersonation issues, and updating its Community Guidelines around recreating existing songs and voice/likeness use. The move follows the EU AI Act's Article 50 transparency rules — which require machine-readable labeling of AI-generated audio and became enforceable August 2, 2026, with a grace period to December 2, 2026 for systems already on the market — plus continued pressure from the label lawsuits above.
