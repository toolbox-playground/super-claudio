...
- **Watermarking + tighter download policy (Aug 6, 2026):** Suno announced inaudible audio watermarking/fingerprinting (survives editing and compression, SynthID-style) plus a new download policy aimed at curbing mass-distribution abuse — exact caps/tiers/start date not yet published, and Suno says it won't affect most individual users. Rewritten community guidelines now explicitly ban uploading copyrighted material, reproducing existing songs, or using real voices without permission. Suno's next-gen "V6" model is still **not released** as of August 2026 (still described as in development); litigation continues to escalate — Round Hill Music filed separate copyright suits against Suno (and Anthropic) on Aug 17, 2026, seeking damages potentially exceeding $1B each.
