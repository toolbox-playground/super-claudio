...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 released and became default Jul 24 2026 — new unified Edit Model replaces Omni Reference, Character Reference, and Retexture; native 2K output, rebuilt Personalization engine tuned to individual aesthetic taste, bolder/more sophisticated default look; supersedes v8.1 (Apr 30 2026 – Jul 23 2026) | Paid (no free tier) |
...
| **GPT Image 2** | ChatGPT / API | Complex instructions, text in images (99% accuracy), 4K resolution, 2× faster than predecessor; launched April 21, 2026; **#1 on Artificial Analysis Text-to-Image Arena (Elo ~1339, July 2026)**; still #1 on Arena text-to-image as of Aug 2026 | Limited (ChatGPT Plus) |
| **Grok Imagine Image 2.0** (xAI) | grok.com/imagine (web, iOS, Android — "Quality Mode") | Precise region-level editing (magic wand, segmentation, background removal with transparency), multi-reference generation from up to 5 input images, Smart Resize across 9 aspect ratios, sharp typography for dense text layouts; posters, product shots, headshots; launched Aug 7, 2026; **#2 on Arena text-to-image (Elo 1320, behind GPT Image 2's 1380) and #2 in image editing (Elo 1439)** | Paid only — no free tier (image gen requires SuperGrok, $30/mo; API access announced but not yet available) |
...
| **MAI-Image-2.6** (Microsoft) | microsoft.ai (MAI Playground), Azure AI Foundry, openrouter.ai/microsoft (2.5 listed; 2.6 rollout in progress) | High-quality generation and precise localized editing; launched Aug 10, 2026 — **#2 on Arena text-to-image leaderboard out of 77 systems (behind GPT Image 2 only, ahead of Google/Meta/xAI)**; +91 Elo over MAI-Image-2.5, biggest single jump in Text Rendering; also improved portrait quality and 3D imaging/modeling; supersedes MAI-Image-2.5; integrating into PowerPoint (generation) and OneDrive (photo editing) | No free tier; official 2.6 pricing not yet published (2.5 API pricing was $47/1M image output tokens standard, $33/1M Flash; text input $5/1M standard, $1.75/1M Flash) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — plans layout, hierarchy, and text placement before rendering a pixel, so you can fix a misplaced headline or resize one element without re-rolling; native 4K output with no upscaling pass; instruction-based edits as cheap as $0.01/operation (object swaps, relights, text corrections priced like operations instead of full re-renders); text-to-image, multi-reference composition; Reve 2.0 debuted #2 on Image Arena (score 1280) June 3, 2026; 2.1 shipped mid-July 2026 | Free tier (daily refresh; opted into model training by default); Lite $7.99/mo; Pro $19.99/mo (opt out of training, unlocks video); API ~$0.20/image, $0.01/edit |
...
| **Riverflow 2.5 Pro** (Sourceful) | openrouter.ai/sourceful/riverflow-v2.5-pro, runware.ai, wavespeed.ai | Photorealistic product mockups, packaging, ads, brand assets — reasoning image model built on Riverflow 2.0's #1 Artificial Analysis Image Generation ranking (Feb 2026); adds deeper multi-step reasoning, stronger review controls, Font Control, background output modes, up to 4K exports; released June 4, 2026, supersedes Riverflow 2.0 Pro; agentic precision for commercial/brand-accurate imagery | API credits (dynamic per-job pricing, roughly $0.13/image at 1024px to $0.17/image at 4096px; free rate-limited tier via OpenRouter; no direct consumer site — API only) |
...
- **Ranked #2** on Arena.ai text-to-image, single-image edit, and multi-image edit leaderboards at launch (Elo 1280, July 2026) — since passed on text-to-image by MAI-Image-2.6 (Aug 10) and Grok Imagine Image 2.0 (Aug 7); still competitive on the edit leaderboards
