...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default version Jul 24 2026 (up from v8.1, released Apr 30 2026) — stronger aesthetics/taste modeling for bolder, more sophisticated images, better personalization-profile understanding, improved Sref/moodboard consistency, Big Batch Draft Mode with `--sref random` for 24× faster style exploration | Paid (no free tier) |
| **Grok Imagine Image 2.0** (xAI) | grok.com/imagine, Grok iOS/Android apps | Precision editing — Magic Wand for single-region edits, Segmentation for precise selections, Smart Resize across 9 aspect ratios; up to 5 reference images combined in one generation/edit; sharp small-text rendering; ready-made templates (product shots, headshots, icons, merch); launched as Grok's "Quality Mode" Aug 7 2026; **#2 on Arena.ai Text-to-Image leaderboard**, behind GPT Image 2 | ~10 images/day free via Grok chat prompts; full Quality Mode needs SuperGrok Lite ($10/mo, ~20/day) or SuperGrok ($30/mo); no API yet |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition; native 4K output; released Jul 9 2026 (one month after 2.0), sharper prompt understanding, world knowledge, and foreign-text rendering; **#2 on Artificial Analysis Text-to-Image Arena (Elo ~1323, Aug 2026)** — top-ranked independent-lab model | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
...
| **Qwen Image 3.0 Pro** (Alibaba) | Qwen Chat (rolling out), invite-only API (openrouter.ai/qwen/qwen-image-3-pro and other aggregators) | Long-document/complex-layout generation — accepts up to 4.5K-token prompts in a single pass, renders legible 10px text, formulas, geometric diagrams, and multi-layered UI mockups; native support for 12 languages and 20+ fonts; released Jul 21 2026 without open weights or a technical report; **#5 on Arena.ai Text-to-Image Arena (Elo 1263, Aug 2026)** | Invite-only API, no self-serve consumer site yet; some third-party aggregators offer quota-capped free access |
| **Riverflow 2.5** (Sourceful) | openrouter.ai/sourceful/riverflow-v2-pro, runware.ai, wavespeed.ai | Reasoning image model for production creative workflows — released Jun 5 2026, builds on Riverflow 2.0 Pro's multi-step editing with deeper reasoning, custom scoring rubrics (tell the model what to optimize for), Font Control, background output modes, up to 4K exports; photorealistic product mockups, packaging, ads, brand assets | API credits ($0.15/image 2K, $0.33/image 4K; no direct consumer site — API only) |
...
## FLUX 3 — Announced, Not Yet Available for Images

Black Forest Labs announced FLUX 3 on July 23, 2026: a unified multimodal model spanning image, video (up to 20s with native synced audio), and robotics action-prediction in one shared architecture — a pivot from still images toward what BFL calls "visual intelligence." FLUX 3 Video is in gated early access now; **FLUX 3 Image has not shipped yet** (still "coming weeks" as of Aug 2026) — keep using FLUX.2 [max]/[pro] for image work until it lands. An open-weight FLUX 3 Dev model and FLUX 3 Action (robotics) are both planned later in 2026.
