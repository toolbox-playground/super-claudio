...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits, moodboards; v8.2 became the default model July 24, 2026 (v8.1 released Apr 30 2026, was default Jun 11–Jul 24 2026); focuses on image quality, bolder creative choices, and stronger personalization; introduces a new Edit Model that replaces Omni Reference, Character Reference, and the Retexture tool | Paid (no free tier) |
...
| **GPT Image 2.5** (OpenAI) | ChatGPT / API | Complex instructions, text in images, 4K resolution; GPT Image 2.5 shipped Sept 8, 2026 as the successor to GPT Image 2 (launched April 21, 2026), cutting generation latency ~50%; new `@Sketch` feature turns a drawing into an AI image directly in chat; API ships as two variants — Flare (fast, everyday default) and Sunburst (higher-precision editing); GPT Image 2 remains #1 on the Artificial Analysis Text-to-Image Arena as of Sept 2026 | Limited (ChatGPT Plus); API: $8 / $30 per 1M input/output tokens (both Flare and Sunburst) |
...
| **MAI-Image-2.6 / Flash** (Microsoft) | microsoft.ai (MAI Playground), Azure AI Foundry, openrouter.ai/microsoft/mai-image-2.6 | High-quality generation and precise multi-reference editing — combines people, products, styles, and scenes from up to 5 input images while preserving composition; launched Sept 4, 2026, replacing MAI-Image-2.5; #2 on the Arena text-to-image leaderboard, ahead of Google, Meta, and xAI; +79 Elo over MAI-Image-2.5 overall, +91 Elo in text rendering; Flash variant is 2×+ faster than GPT Image 2 (Medium); public preview in Microsoft Foundry | No free tier (public preview pricing: text input $5/1M tokens, image input $8/1M tokens, image output $38/1M tokens) |
| **Grok Imagine Image 2.0** (xAI) | grok.com/imagine, iOS/Android apps, docs.x.ai (API) | Region-level (localized) editing, multi-image reference inputs (up to 3 source images per edit), 1K/2K output across 9 aspect ratios; launched in xAI's apps Aug 7, 2026 (API access Aug 8); ranks #2 on Arena text-to-image and image-editing leaderboards, behind GPT Image 2 | Limited free (Grok app); API: flat per-image pricing, $0.04 (1K low) – $0.08 (2K medium); +$0.01 per input image for edits |
...
| **Reve 2.0** (Reve AI) **— SHUTTING DOWN Sept 27, 2026, see note below** | app.reve.com (through Sept 27; login/export only through Oct 31) | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition; native 4K output; debuted #2 on Image Arena (score 1280, launched June 3, 2026); **do not start new projects here — see deprecation note** | Closed to new signups/subscriptions since Sept 17, 2026 |
...
## Reve AI Shutdown Note

Reve is ending its image generation product. Following an investment from OpenAI, Reve's AI research team is joining OpenAI to lead multimodal research, and Reve is moving its product studio away from creative tooling. Key dates: the Reve API was discontinued August 14, 2026; new signups and subscriptions closed September 17, 2026; image generation on reve.com stops September 27, 2026; account login and library export remain available through October 31, 2026, after which the login closes. Active paid plans get a refund for September. Do not recommend Reve for new projects — for a similar layout-first / typography-focused workflow, point users to Recraft V4.1 or Ideogram 4.0 instead.
