...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default/GA version on Jul 24 2026 (up from v8.1's Apr 30 2026 release) — aesthetic refinements, better Sref/moodboard consistency, Big Batch Draft Mode with `--sref random` for 24× faster style exploration; retains v8.1's 5× speed vs v7, native 2K resolution, improved text rendering | Paid (no free tier) |
...
| **GPT Image 2.5** | ChatGPT / Codex / API | Successor to GPT Image 2 (launched Sep 8, 2026); ~50% lower latency, better subject/reference consistency across multi-round edits, more precise localized edits; two API variants — Flare (faster) and Sunburst (higher detail); complex instructions, text in images (99% accuracy), 4K resolution | Limited (ChatGPT Plus) |
| **GPT Image 2** | ChatGPT / API | Complex instructions, text in images (99% accuracy), 4K resolution, 2× faster than predecessor; launched April 21, 2026; **#1 on Artificial Analysis Text-to-Image Arena (Elo ~1339, July 2026)**; superseded by GPT Image 2.5 (Sep 8, 2026) | Limited (ChatGPT Plus) |
