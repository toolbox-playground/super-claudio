...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default model on Jul 24 2026 (v8.1 had been default Jun 10–Jul 23 2026) — focused on aesthetics and personalization: bolder/more sophisticated default outputs, fewer low-quality generations, personalization profiles that better learn taste from rating history; v8.1's gains carry forward (5× faster than v7, native 2K resolution, improved text rendering) | Paid (no free tier) |
...
| **MAI-Image-2.5-Pro** (Microsoft) | Microsoft Foundry (preview), microsoft.ai | Highest-fidelity Microsoft image model — hero imagery, detailed editing, precise in-image text; launched July 23, 2026; **#1 on Artificial Analysis Image Editing Leaderboard** (Elo 1271, beating GPT Image 2 and Reve 2.1) and top-10 on Text-to-Image, reached within a month of launch | Preview (Microsoft Foundry); API ≈$5/1M text input tokens, $8/1M image input tokens, $106/1M image output tokens (≈$108.5 per 1K 1024×1024 images) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first native-4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; ~3× the parameters of Reve 2.0 (released July 9, 2026); **#2 on Artificial Analysis Image Editing Arena** (Elo 1263); edit operations priced separately from full generations | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo; API ≈$0.20/generation, edits ≈$0.01/operation |
...
| **Seedream 5.0 Pro** (ByteDance) | seed.bytedance.com, byteplus.com, fal.ai | Precision editing + layered output — launched July 8, 2026; splits one render into 10+ transparent PNG layers (auto-fills occluded areas for maskless editing in Figma/Photoshop); pixel-level spatial grounding for interactive regional edits; multilingual text generation in 10+ languages (Chinese, English, French, German, Russian, Japanese, Korean, Spanish, Arabic — includes RTL layouts); realistic portrait textures and multi-person compositing; available via BytePlus API, Doubao/Jimeng consumer apps, fal.ai, and ComfyUI | Official BytePlus API: $0.045/image ≤2.36MP; $0.09/image >2.36MP; first reference image free, $0.003 per extra (third-party resellers may charge more, e.g. ~$0.075–$0.15/image) |
| **Riverflow 2.5 Pro** (Sourceful) | openrouter.ai/sourceful/riverflow-v2.5-pro, runware.ai, wavespeed.ai | Photorealistic product mockups, packaging, ads, brand assets — released June 2026, supersedes Riverflow 2.0 Pro; integrated reasoning model plans multi-step edits and judges candidates before returning a result; adds Font Control and background output modes; up to 4K exports; ranks #1 in Design Arena's Image, Graphic Design, and Image Editing categories; Fast variant available for lower-cost/lower-latency jobs | API credits (Pro: ~$0.13/image 1024px–$0.17/image 4K, scales with reasoning effort; Fast: from ~$0.019/image; no direct consumer site — API only) |
...
| **Qwen Image 3.0** (Alibaba) | fal.ai/models/alibaba/qwen-image-3, openrouter.ai/qwen/qwen-image-3-pro | Dense layouts, infographics, UI mockups, multilingual text (12+ languages) in images, image editing; prompts up to 4,500 tokens; released July 21, 2026, GA August 5, 2026; ships as Pro and Standard editions; no published benchmark table or open weights at launch (departure from earlier Qwen Image releases) | Consumer pricing from ~¥0.18/image; API (fal.ai): Pro ~$0.04/image 1K, ~$0.075/image 2K; Standard flat ~$0.03/image |
