...
|------|--------|----------|
| **Midjourney V8.2** | midjourney.com | Artistic quality, concept art, portraits; V8.2 became the default Jul 24, 2026 (replaced V8.1, default since Jun 10); new Edit Model replaces Omni Reference/Character Reference/Retexture; sharper aesthetics, better personalization from rating history, aspect ratios up to 14:1 (SD) / 4:1 (HD) | Paid (no free tier) |
...
| **GPT Image 2.5** | ChatGPT / API | Complex instructions, text in images (99% accuracy), 4K resolution, up to 50% faster than GPT Image 2, more reliable multi-turn editing, new Sketch feature (drawing → AI image); launched Sept 8, 2026 across ChatGPT, ChatGPT Work, and Codex; API variants Flare (fast) and Sunburst (higher quality); **#1 on Artificial Analysis Text-to-Image Arena** | Free (rolled out across all ChatGPT tiers, not just Plus) |
| **Grok Imagine Image 2.0** (xAI) | grok.com, x.ai API | Typography/layout planning, reference-based editing; launched in Grok apps Aug 7, 2026, API Aug 8; consistently #2–#3 on Artificial Analysis Image Arena (oscillates with MAI-Image-2.6/GPT Image 2.5) | Free inside Grok apps; API $0.04–0.08/image output (1K–2K), $0.01/image input |
| **Meta Muse Image** (Meta Superintelligence Labs) | meta.ai, Meta AI app, Instagram Stories (US), WhatsApp (limited countries) | Social-native image generation — text-to-image, multi-photo blending, sketch-and-instruction editing, 30+ Instagram Story effects; agentic tool use (web search + coding invoked during generation); self-refinement at inference time (test-time compute scaling before delivering the final image); Content Seal invisible watermark; launched July 7, 2026; **#2 on Arena.ai Text-to-Image Arena (Elo 1280, July 2026)** — also #2 in single-image edit and multi-image edit arenas; no developer API at launch (Meta evaluating external access). Note: the @mention-a-public-Instagram-account likeness-reference feature was pulled just 3 days after launch (Jul 10, 2026) after a consent/privacy backlash — do not reference it as available | Free (consumer; subscription for power users via Meta AI subscription plans) |
| **MAI-Image-2.6 / Flash** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.6, Azure AI Foundry | High-quality generation and precise localized editing; Public Preview on Microsoft Foundry since Sept 4, 2026; **#2 on Artificial Analysis Text-to-Image Arena** (+79 Elo over 2.5); multi-reference editing (up to 5 images), web grounding, dynamic aspect ratios; Flash variant for lower cost/latency; integrating into PowerPoint (generation) and OneDrive (photo editing) | No free tier (API: $47/1M image output tokens standard; $33/1M Flash; text input: $5/1M standard, $1.75/1M Flash) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; native-4K "image as code" regional/element-level editing (bumped from 2.0 ~Jul/Aug 2026) | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo; API ~$0.20/create-or-edit ($10 min for 7,500 credits) |
...
| **Riverflow V2.5 Pro** (Sourceful) | openrouter.ai/sourceful/riverflow-v2.5-pro, runware.ai, wavespeed.ai | Photorealistic product mockups, packaging, ads, brand assets — released June 2026; integrated reasoning model plans multi-step edits and judges candidates before returning results; 4K output, transparent background support, agentic precision for commercial imagery | Free via OpenRouter (`sourceful/riverflow-v2.5-pro:free`); API credits otherwise ($0.13–$0.17/image, dynamic; no direct consumer site) |
...
Meta Superintelligence Labs launched Muse Image on July 7, 2026: Meta's first image generation model from MSL. It composes scenes from your own photo library and supports sketch-and-instruction editing across Instagram, WhatsApp, and the Meta AI app. Agentic tool use means it can call web search or run code as part of a generation request. Test-time compute scaling refines the output before you see it.

**Note:** the original launch also let you @mention a public Instagram account to use that person's photos as a likeness reference. Every public adult account was auto-enrolled with no opt-in or notification, which drew a fast backlash (privacy advocates, SAG-AFTRA, CAA). Meta pulled the feature on July 10, 2026 — three days after launch — saying "it's no longer available." The rest of Muse Image remains live; do not tell users the Instagram-reference feature still works.
...
- Best for: social-first creators already in the Meta ecosystem; own-photo-library composition; Instagram Story effects workflows
