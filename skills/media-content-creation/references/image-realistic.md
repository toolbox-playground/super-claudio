...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; V8.2 (preview began Jun 25 2026, became the default Jul 24 2026) — aesthetic refinements over v8.1, better Sref/moodboard consistency, Big Batch Draft Mode with `--sref random` for 24× faster style exploration, improved text rendering; V9 is in active development as of Sept 2026 (smarter/more coherent, new upscalers, brush-based inpainting for edits) with no GA date announced yet | Paid (no free tier) |
...
| **GPT Image 2.5** (OpenAI) | ChatGPT / API (`gpt-image-2.5-flare`, `gpt-image-2.5-sunburst`) | Complex instructions, text in images, sketch-to-image (turn a drawing into a finished image); launched Sept 8, 2026 as "ChatGPT Images 2.5", replacing GPT Image 2; Flare variant is the fast/high-volume model (up to 50% lower latency), Sunburst is the higher-precision variant; **#1 on Artificial Analysis Text-to-Image Arena** (Sunburst Elo 1197, Flare Elo 1190, Sept 2026) and #1 Image Editing Arena | Limited (ChatGPT Plus); API: token-metered ($5/1M text-in, $8/1M image-in, $30/1M image-out tokens — roughly $0.01–$0.21/image depending on size/quality) |
| **Grok Imagine Image 2.0** (xAI) | grok.com/imagine, Grok iOS/Android apps, openrouter.ai/x-ai/grok-imagine-image-2.0 | Precise regional editing — magic-wand tool edits only the region you point at, segmentation, background removal with transparency export, up to 5 reference images per generation; strong typography/layout planning for dense multi-part visuals; launched Aug 7, 2026 as Grok's "Quality Mode"; **#2 on Artificial Analysis Text-to-Image and Image Editing Arenas at launch** (behind GPT Image 2 then, since passed by GPT Image 2.5 too) | No free tier (Grok Imagine dropped free access Mar 19, 2026) — SuperGrok Lite $10/mo (~20 images/day) minimum, or via OpenRouter API |
...
| **Reve 2.1** (Reve AI) **— SHUTTING DOWN, do not build new workflows on this** | app.reve.com (until Sept 27, 2026) | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; Reve 2.1 (Jul 9 2026) reached #2 on the Text-to-Image Arena (Elo 1306); Reve API was discontinued Aug 14, 2026, new sign-ups/renewals stopped Sept 17, 2026, and the web app stops generating entirely Sept 27, 2026 (downloads allowed through Oct 31) after Reve's research team moved to OpenAI post-investment | Was free tier + Lite $7.99/mo + Pro $19.99/mo — no longer accepting new subscribers; service ending Sept 27, 2026, use FLUX.2, Nano Banana, or Ideogram for layout/typography needs instead |
...
DALL-E 2 and DALL-E 3 were retired by OpenAI on May 12, 2026. GPT Image 2.5 (already in the table above, launched Sept 8, 2026 as the successor to GPT Image 2) is their replacement. Do not recommend DALL-E endpoints — they are deprecated.
...
## Reve AI Shutdown Note (September 2026)

Reve AI is discontinuing its image generation product following an investment from OpenAI (its research team joined OpenAI to work on multimodal research). Timeline: the Reve API was already discontinued August 14, 2026; new sign-ups and subscription renewals stopped September 17, 2026; the web app (app.reve.com) stops generating entirely September 27, 2026; users can download prior work through October 31, 2026; paid subscribers who were charged for September get a full refund. Do not recommend Reve for new work — point users to FLUX.2, Nano Banana, or Ideogram for layout-first/typography-heavy needs instead.
