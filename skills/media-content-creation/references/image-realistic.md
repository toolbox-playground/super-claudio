...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default model July 24, 2026 (announced in preview June 25, 2026), superseding v8.1 (Apr 30 2026) — native 2K resolution, rebuilt personalization engine trained on a larger image pool, more creative/bold/edgy output with fewer low-quality generations, improved prompt tools | Paid (no free tier) |
...
| **MAI-Image-2.6** (Microsoft) | microsoft.ai (MAI Playground), Azure AI Foundry (rollout pending as of launch) | High-quality generation and precise localized editing; launched Aug 10, 2026, debuting **#2 on Arena's text-to-image leaderboard** — ahead of Google's Nano Banana models, Meta Muse Image, and xAI Grok Imagine, behind only GPT Image 2; +91 Elo gain focused on clearer text and more reliable layouts for posters/packaging/branded assets, plus improved portrait quality and 3D imaging/modeling; supersedes MAI-Image-2.5 (June 2026); integrating into PowerPoint (generation) and OneDrive (photo editing) | No free tier (pricing not yet published for 2.6; predecessor 2.5 was $47/1M image output tokens standard, $33/1M Flash) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition; native 4K output; released July 9, 2026 (up from 2.0, June 3, 2026) with sharper prompt understanding, stronger world knowledge, more accurate spatial reasoning, and improved foreign-text rendering — a +17 Elo gain, closing the gap with GPT Image 2 | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
