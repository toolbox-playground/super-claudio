...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default model July 24, 2026, succeeding v8.1 — bolder/more sophisticated default look, larger personalization profile pool with better preference-matching, Big Batch Draft Mode (`--sref random`, 24 images/batch, 24× faster style exploration) now standard | Paid (no free tier) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first native 4K (16MP) generation — plans structured, editable regions before rendering; strongest-in-class typography/text legibility; text-to-image, image editing, multi-reference composition; **#2 on Text-to-Image Arena (Elo ~1301–1306, released July 9, 2026)** — just behind GPT Image 2, up from v2.0's #2 at Elo 1280 | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
