...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default Jul 24 2026 — new unified Edit Model replaces Omni Reference, Character Reference, and Retexture with a single in-lightbox editor driven by plain-language instructions plus up to 4 reference images; aesthetic pass makes output bolder/more sophisticated; sharper Personalization that better learns your taste; builds on v8.1 (Apr 30 2026) — 5× faster than v7, native 2K resolution, improved text rendering | Paid (no free tier) |
...
| **Grok Imagine Image 2.0** (xAI) | grok.com/imagine, Grok iOS/Android apps, API (`grok-imagine-image-2.0`) | Fast, cheap, sharp typography — runs on xAI's autoregressive Aurora engine; launched as a new "Quality Mode" Aug 7, 2026; region-level editing (magic-wand selection, segmentation, background removal with transparency), multi-reference generation from up to 5 input images, Smart Resize across 9 aspect ratios; **#2 on Artificial Analysis Arena in both text-to-image (Elo 1320) and image editing (Elo 1439)**, behind only GPT Image 2 | Free tier removed Mar 19, 2026 (requires X Premium/X Premium+ or SuperGrok, plans from $10/mo); API: $0.04/image |
...
| **MAI-Image-2.6 / Flash** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.6, Azure AI Foundry (Public Preview) | High-quality generation and precise localized editing; launched Aug 10, 2026 — **#1 on Artificial Analysis Image Editing leaderboard**, #2 text-to-image, ahead of Google, Meta, and xAI; +79 pts overall Elo over MAI-Image-2.5, biggest gain in Text Rendering (+91); adds multi-image reference editing, web grounding, dynamic aspect ratios up to 1.5K; strong portraits, 3D imagery, and commercial/photorealistic output; Flash variant tuned for latency-sensitive, high-throughput work; supersedes MAI-Image-2.5 | No free tier (API: $38/1M image output tokens standard, $19/1M Flash; image input: $8/1M standard, $2.50/1M Flash; text input: $5/1M standard, $1.75/1M Flash) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition; native 4K output; Reve 2.1 (launched Jul 9, 2026; ~3× the parameters of 2.0) cut edits to $0.01/operation, making Reve an editor-first tool for most users; standalone developer API was sunset Aug 14, 2026 (consumer app at app.reve.com unaffected) | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
...
| **Seedream 5.0 Lite** (ByteDance) | seed.bytedance.com, byteplus.com | Lower-cost tier of the Seedream 5.0 line, launched Aug 13, 2026 — same chain-of-thought visual reasoning and real-time web-search grounding as Pro (pulls live web results for time-sensitive or trending-topic prompts), trimmed for cost and speed; 2K/4K rendering, multiple aspect ratios, up to 4 images per request | API: ~$0.035/image |
