...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default version Jul 24 2026 (up from v8.1, default since Jun 11 2026) — more creative/bold/sophisticated aesthetics, dramatically fewer low-quality outputs, Personalization better tuned to individual taste, Big Batch Draft Mode with `--sref random` for 24× faster style exploration | Paid (no free tier) |
...
| **GPT Image 2** | ChatGPT / API | Complex instructions, text in images (99% accuracy), 4K resolution, 2× faster than predecessor; launched April 21, 2026; **#1 on Artificial Analysis Text-to-Image Arena (Elo 1370, Aug 2026)** — leads #2 by ~97 Elo, the widest gap on the leaderboard | Limited (ChatGPT Plus) |
...
| **MAI-Image-2.5-Pro** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.5-pro, Microsoft Foundry | Microsoft's quality-focused flagship — **#1 on Artificial Analysis Image Editing Arena (Elo 1272)**, #7 on Text-to-Image Arena; launched July 23, 2026 in preview on Microsoft Foundry; strongest of the MAI-Image family for precise localized edits and product imagery | Preview (pricing not yet published; see MAI-Image-2.5/Flash row below for prior-gen API rates) |
| **MAI-Image-2.5 / Flash** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.5, Azure AI Foundry | High-quality generation and precise localized editing (launched June 2, 2026 at Microsoft Build); +75 pts over MAI-Image-2, biggest gains in Text Rendering (+107) and Cartoon/Anime/Fantasy (+90); strong product imagery, text rendering, and prompt adherence; Flash variant for 2.7× lower cost; integrating into PowerPoint (generation) and OneDrive (photo editing); superseded as Microsoft's top-ranked model by MAI-Image-2.5-Pro (above) | No free tier (API: $47/1M image output tokens standard; $33/1M Flash; text input: $5/1M standard, $1.75/1M Flash) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled, with stronger foreign-text rendering than 2.0; text-to-image, image editing, multi-reference composition; native 4K output; **#2 on Artificial Analysis Text-to-Image Arena (Elo 1306, Aug 2026)** — behind only GPT Image 2; launched July 9, 2026; API edits as low as $0.01/operation | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
...
| **Qwen Image 3.0** (Alibaba) | chat.qwen.ai (Qwen Studio), Alibaba Cloud Model Studio API | Dense, information-rich images — infographics, multi-panel documents, legible small text (down to 10px) from instructions up to 4,500 tokens; 12 languages; positioned as a tool for deployable documents/infographics rather than pure aesthetics; launched Aug 5, 2026 as a closed model — no weights, model card, or benchmark scores published (a reversal from the open Qwen-Image 1.0/2.0 releases) | Free (Qwen Studio, usage-limited); API pricing not yet published (2.0 family: $0.03–$0.075/image) |
