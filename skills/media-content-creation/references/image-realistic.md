...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default model July 24, 2026 (was in `--preview` since June 25) — aesthetic refinements, better Sref/moodboard consistency, Big Batch Draft Mode with `--sref random` for 24× faster style exploration; v8.1 (Apr 30 2026) remains available — 5× faster than v7, native 2K resolution | Paid (no free tier) |
...
| **MAI-Image-2.6** (Microsoft) | microsoft.ai (MAI Playground), Azure AI Foundry (private preview) | High-quality generation and precise localized editing; launched Aug 10, 2026 — now #2 overall on Arena, ahead of Nano Banana 2 and Meta Muse Image; +79 pts over MAI-Image-2.5, +91 in Text Rendering; strong product imagery, text rendering, and prompt adherence; supersedes MAI-Image-2.5/Flash | No free tier (pricing not yet published for 2.6; 2.5 was $47/1M image output tokens standard, $33/1M Flash) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; improved non-English text rendering vs 2.0; released July 9, 2026, debuted #2 on Image Arena (Elo 1306); $0.01/edit | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
| **Qwen-Image-3.0** (Alibaba) | qwen.ai, HuggingFace | Dense, information-heavy single-pass images — infographics, math notation, diagrams; accepts up to 4,500-token instructions; GA August 5, 2026; shipped without published benchmarks/model card | From ~¥0.18/image (Qwen consumer platform) |
