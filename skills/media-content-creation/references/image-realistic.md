...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default model Jul 24, 2026 (preview began Jun 25) — stronger aesthetics and personalization understanding, more creative/bold output, fewer low-quality results, Big Batch Draft Mode with `--sref random` for 24× faster style exploration; v8.1 (Apr 30 2026) remains available — 5× faster than v7, native 2K resolution | Paid (no free tier; $10–$120/mo tiers, 20% off annual; no free trial) |
...
| **Nano Banana 2** (Google / Gemini) | gemini.google.com | Product images, lifestyle scenes, ad creatives — default free model (Gemini 3.1 Flash Image); **#3 on Artificial Analysis Text-to-Image Arena (Elo 1317, Aug 2026)** — ahead of GPT Image 1.5 and MAI-Image-2.5 | Free (Gemini app) |
...
| **GPT Image 2** | ChatGPT / API | Complex instructions, text in images (99% accuracy), 4K resolution, 2× faster than predecessor; launched April 21, 2026; **#1 on Artificial Analysis Text-to-Image Arena (Elo 1369, Aug 2026)** — lead over #2 (Reve 2.1, Elo 1324) has widened since July | Limited (ChatGPT Plus) |
...
| **MAI-Image-2.6** (Microsoft) | microsoft.ai (MAI Playground), Microsoft Foundry (private preview) | High-quality generation and precise localized editing; launched Aug 18, 2026 — **#2 on Arena text-to-image** (ahead of Google, Meta, and xAI), #3 on Arena image editing (ahead of Nano Banana and Meta Muse families); +79 Elo over MAI-Image-2.5, biggest single gain in text rendering (+91); improved portraits, 3D images, and multi-reference workflows; commercial pricing not yet public (Foundry access still private preview) | No free tier; prior MAI-Image-2.5 API pricing: $47/1M image output tokens standard, $33/1M Flash |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; ~3× the parameters of 2.0, stronger prompt understanding, world knowledge, dense/complex-scene reasoning, and multilingual/foreign-text rendering; edits from $0.01; native 4K, no upscaler; released Jul 9, 2026; **#2 on Artificial Analysis Text-to-Image Arena (Elo 1324, Aug 2026)** — behind only GPT Image 2, ahead of Nano Banana 2 and MAI-Image-2.5 | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
...
| **Qwen Image 3.0 / 3.0 Pro** (Alibaba) | chat.qwen.ai, Qwen Studio, openrouter.ai/qwen | Dense, information-heavy layouts — newspaper pages, UI mockups, storyboards, knowledge diagrams (formulas + geometry + derivation steps), e-commerce imagery; accepts prompts up to 4,500 tokens, renders text as small as 10px, 12 languages, image editing built into the same model; launched Aug 5, 2026, jumped straight to **#5 on Artificial Analysis Text-to-Image Arena (Elo 1263)** — tied with Nano Banana 2, up sharply from Qwen Image 2.0 Pro's #15; shipped with no benchmark report, model card, or open weights, unlike prior Qwen Image releases | Standard $0.03/image (1K/2K); Pro $0.04/image (1K), $0.075/image (2K); limited-time free quota on some hosts (not a lasting free tier) |
| **Riverflow 2.5 Pro** (Sourceful) | openrouter.ai/sourceful/riverflow-v2.5-pro, runware.ai, wavespeed.ai | Photorealistic product mockups, packaging, ads, brand assets — unified text-to-image + image-to-image treated as a production workflow; integrated reasoning model with controllable effort (low/medium/high/xhigh) plans multi-step edits and judges candidates before returning a result; up to 10 reference images per request; 1K/2K/4K output, transparent background support; released Jun 4, 2026, succeeding Riverflow 2.0 (Feb 2026, #1 on Artificial Analysis at launch) | API credits, cost scales with reasoning effort/resolution ($0.13/image 1K – $0.17/image 4K; no direct consumer site — API only) |
