...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; **v8.2 became the default model July 24, 2026** (up from v8.1, default Jun 11–Jul 24 2026) — aesthetic refinements, better Sref/moodboard consistency, Big Batch Draft Mode (`--sref random`, 24× faster style exploration), new **Edit Model** replacing Omni Reference/Character Reference/Retexture | Paid (no free tier) |
...
| **MAI-Image-2.6-Preview** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.6, Azure AI Foundry | Launched Aug 10, 2026, supersedes MAI-Image-2.5; **#2 on Artificial Analysis Text-to-Image Arena (Elo 1349) and #1 on Image Editing Arena (Elo 1286)** — beats Google, Meta, and xAI on editing; strong product imagery, text rendering, and prompt adherence; integrating into PowerPoint (generation) and OneDrive (photo editing) | No free tier (API pricing TBD at preview; MAI-Image-2.5 was $47/1M image output tokens standard, $33/1M Flash) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Released July 9, 2026, succeeds Reve 2.0 with a +36 Elo jump in one month; layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
| **Grok Imagine Image 2.0** (xAI) | grok.com, x.ai/api | Launched Aug 7, 2026; ranks #2 in blind text-to-image and image-editing tests behind only GPT Image 2; typography-aware generation | No free tier (Grok removed free image gen Mar 19, 2026) — SuperGrok subscription ($10–30/mo) or API ~$0.04–0.08/image via OpenRouter |
...
| **FLUX 3** (Black Forest Labs) | bfl.ai | **Announced July 23, 2026** as BFL's new multimodal flagship, generating image + up to 20s video/audio jointly — successor line to FLUX.2. FLUX 3 Video/Action reached general availability Aug 4–5, 2026; **FLUX 3 Image was still rolling out ("coming in the following weeks") as of early August 2026** — check bfl.ai for current image-generation availability before relying on it; open-weight FLUX 3 Dev planned later in 2026 | API credits (pricing TBD) |
