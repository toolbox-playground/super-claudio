...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; became the default model July 24, 2026 (up from v8.1, default since Jun 11 2026) — aesthetic refinements, better Sref/moodboard consistency, Big Batch Draft Mode with `--sref random` for 24× faster style exploration; no v9 yet — Midjourney says it needs a larger base model and is a future item, not imminent | Paid (no free tier) |
...
| **Nano Banana 2** (Google / Gemini) | gemini.google.com | Product images, lifestyle scenes, ad creatives — default free model (Gemini 3.1 Flash Image) in the consumer Gemini app; **the Developer API has no free tier** (~$60/1M output image tokens) — free access is interactive-only via the Gemini app or AI Studio testing, not for production API use | Free (Gemini app, AI Studio testing only) |
...
| **GPT Image 2.5** | ChatGPT / API | Complex instructions, text in images, sketch-to-image; two API variants — Flare (fast) and Sunburst (higher quality/detail); launched Sept 8, 2026, replacing GPT Image 2; **ranks #1–#3 on Artificial Analysis Text-to-Image Arena** | Free (ChatGPT free tier, plan limits); API: $0.006–$0.211/image by quality, or $8/1M input + $30/1M output image tokens |
| **GPT Image 2** (superseded by 2.5 above) | ChatGPT / API | Complex instructions, text in images (99% accuracy), 4K resolution; launched April 21, 2026 | Limited (ChatGPT Plus) |
...
| **MAI-Image-2.6 / 2.6 Flash** (Microsoft) | microsoft.ai (MAI Playground), Microsoft Foundry / Azure AI | High-quality generation, multi-image reference editing, web grounding; launched Aug 14, 2026 (Flash variant Sept 4, 2026), replacing MAI-Image-2.5; **#2 on Artificial Analysis Arena (behind GPT Image 2), #1 on image editing**; 20B params, diffusion-based; Public Preview on Microsoft Foundry | No free tier (Public Preview pricing on Microsoft Foundry) |
...
| **Reve 2.1** (Reve AI) | app.reve.com, fal.ai | Layout-first native 4K (4096×4096) generation — objects and text are individually addressable, so you can fix a misplaced headline or resize one element without re-rolling; improved foreign-text rendering vs 2.0; launched July 9, 2026; **#2 on Artificial Analysis Text-to-Image Arena (Elo 1306)** | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
| **Reve 2.0** (superseded by 2.1 above) | app.reve.com | Layout-first 4K generation, dedicated typography step; launched June 3, 2026 | Free tier (daily refresh) |
