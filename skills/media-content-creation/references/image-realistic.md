...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default version July 24, 2026 (no longer preview) — aesthetic refinements over v8.1, better Sref/moodboard consistency, Big Batch Draft Mode with `--sref random` for 24× faster style exploration | Paid (no free tier) |
...
| **Meta Muse Image** (Meta Superintelligence Labs) | meta.ai, Meta AI app, Instagram Stories (US), WhatsApp (limited countries) | Social-native image generation — text-to-image, multi-photo blending, @mention of public Instagram accounts for likeness reference, sketch-and-instruction editing, 30+ Instagram Story effects; agentic tool use (web search + coding invoked during generation); self-refinement at inference time (test-time compute scaling before delivering the final image); Content Seal invisible watermark; launched July 7, 2026; **#2 on Arena.ai Text-to-Image Arena (Elo 1280, July 2026)** — also #2 in single-image edit and multi-image edit arenas; **developer API opened Aug 25, 2026** via the Meta Model API at $0.01/image | Free (consumer; subscription for power users via Meta AI subscription plans); API: $0.01/image |
| **MAI-Image-2.6** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.6, Azure AI Foundry | High-quality generation and precise localized editing; launched Aug 10, 2026 — now **#2 overall on Arena Text-to-Image** (behind only GPT Image 2, ahead of Google/Meta/xAI), +79 Elo over 2.5, biggest gains in text rendering (+91); MAI-Image-2.6-Preview leads the Image Editing arena (Elo 1284); strong product imagery, text rendering, and prompt adherence; Flash variant for 2.7× lower cost; integrating into PowerPoint (generation) and OneDrive (photo editing) | No free tier (API: $47/1M image output tokens standard; $33/1M Flash; text input: $5/1M standard, $1.75/1M Flash) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition; native 4K output; released July 9, 2026 with stronger prompt understanding and foreign-text rendering — **#2 overall on Image Arena (Elo 1306), #3 on Image Editing arena** | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
...
| **Riverflow 2.5 Pro** (Sourceful) | openrouter.ai/sourceful/riverflow-v2-pro, runware.ai, wavespeed.ai | Photorealistic product mockups, packaging, ads, brand assets — released June 18, 2026, adding 4K output, font control, and custom scoring; **#1 across Design Arena's Image, Graphic Design, and Image Editing categories**; transparent background support, agentic precision for commercial imagery | API credits ($0.15/image 2K, $0.33/image 4K; no direct consumer site — API only) |
...
- Developer API opened Aug 25, 2026 via the Meta Model API at $0.01/image
