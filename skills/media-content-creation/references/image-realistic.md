...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default model Jul 24 2026 (v8.1 was default Jun 10–Jul 23 2026) — aesthetics/personalization-focused release (not a speed update): bolder, more creative default style, much stronger Personalization tuning on profiles with many points, native 2K output carried over from v8.1 | Paid (no free tier) |
...
| **Nano Banana Pro** (Google / Gemini 3 Pro Image) | gemini.google.com, aistudio.google.com | Complex compositions, highest Google image quality, 4K output — premium variant of Nano Banana | Paid — **free daily quota removed as of Aug 2026**; "redo with Pro" in the Gemini app now requires a Google AI Plus/Pro/Ultra plan (free users are routed to Nano Banana 2 by default); API: $0.134/image |
| **GPT Image 2** | ChatGPT / API | Complex instructions, text in images (99% accuracy), 4K resolution, 2× faster than predecessor; launched April 21, 2026; added built-in reasoning ("thinking mode" — low/medium/high) that plans composition and checks prompt constraints before rendering; **#1 on Artificial Analysis Text-to-Image Arena (Elo 1370, Aug 2026, up from ~1339 in July) and #1 on the separate Image Editing Arena (Elo 1255)** | Limited (ChatGPT Plus) |
...
| **MAI-Image-2.6** (Microsoft) | microsoft.ai (MAI Playground), Azure AI Foundry (rolling out), Arena | Highest-ranked non-OpenAI model — launched Aug 10, 2026; **#2 on Artificial Analysis Text-to-Image Arena (Elo 1336, behind only GPT Image 2) and #1 on the Image Editing Arena (MAI-Image-2.6-Preview, Elo 1284)**; +79 Elo over MAI-Image-2.5 with gains across every category, biggest in Text Rendering (+91); strong product imagery, branding, and cinematic/photorealistic output; supersedes MAI-Image-2.5/Flash (still available via OpenRouter `microsoft/mai-image-2.5`) | No free tier (API pricing not yet published at launch — check Azure AI Foundry) |
...
| **Qwen Image 3.0 / 3.0 Pro** (Alibaba) | chat.qwen.ai, Alibaba Cloud API, OpenRouter (`qwen/qwen-image-3`, `qwen/qwen-image-3-pro`) | Dense information-heavy layouts — newspaper/UI layouts, infographics, multilingual text (12 languages, ~10px legible text), storyboards, e-commerce imagery; accepts prompts up to ~4,500 tokens; GA Aug 5, 2026 (preview launched Jul 21); **Qwen-Image-3.0-Pro entered Artificial Analysis Text-to-Image Arena at #5 (Elo 1263), sitting ~#7 by mid-Aug 2026** — jump from Qwen-Image-2.0-Pro's #15; unlike prior Qwen-Image releases, shipped without open weights, benchmarks, or a technical report | Free (chat.qwen.ai, rate-limited); API: ~$0.03/image 1K (3.0), $0.04–$0.075/image (3.0 Pro, 1K–2K) |
