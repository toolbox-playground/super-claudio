...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default Jul 24 2026 (up from v8.1, Apr 30 2026) — more creative/bold aesthetics, Personalization now better matches individual taste, Big Batch Draft Mode (`--sref random`, 24× faster style exploration); new Edit Model (replaces Omni Reference, Character Reference, and the Retexture tool) opened to public testing Aug 27, 2026 | Paid (no free tier) |
| **Higgsfield Soul 2.0** | higgsfield.ai | Photorealistic people — fashion-grade portraits, editorial composition, spontaneous posing, contemporary styling; Soul ID trains a consistent digital character from ~20 of your own photos (~3 min) for identity-locked generations across poses/styles/lighting; curated aesthetic presets instead of complex prompts; frequently cited as the top pick specifically for realistic human/fashion photography in 2026 roundups | Free tier (~10 credits/day, watermarked); Basic $9/mo; Plus $49/mo; Ultra $129/mo |
...
| **GPT Image 2.5** | ChatGPT / API | Complex instructions, text in images, 4K resolution; released Sept 8, 2026 (up from GPT Image 2, Apr 21 2026) — new Sketch tool (invoke `@Sketch` to draw a visual reference in chat, with Poster/Merch templates), more natural lighting and richer textures, better subject preservation from reference photos, more reliable multi-turn edits, up to 50% lower generation latency; API ships two variants, Flare (faster) and Sunburst (more detailed); **still #1 on Artificial Analysis Text-to-Image Arena** (Flare/Sunburst variants top the board, Sept 2026) | Limited (ChatGPT Plus) |
...
| **MAI-Image-2.6 / Flash** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.6, Microsoft Foundry | High-quality generation and precise localized editing; launched Sept 4, 2026 (up from MAI-Image-2.5, Jun 2 2026) — **#2 on Arena text-to-image, #1 on image editing**, ahead of leading Meta, Google, and xAI models; +79 Elo over 2.5 overall (Text Rendering +91); up to 5 reference images for consistent people/products/characters; web grounding via Bing Search for real-world subjects; dynamic aspect ratios; Flash variant ~2.8× faster than GPT-Image-2-Medium; both in Public Preview on Microsoft Foundry | No free tier (Public Preview pricing on Microsoft Foundry) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first native 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp; renders a full 16MP; sharper prompt understanding and stronger foreign-text rendering than 2.0; launched Jul 9, 2026 (up from Reve 2.0, Jun 3 2026) — **#2 on Text-to-Image Arena (Elo 1306)**, behind only OpenAI's GPT Image models | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
| **Grok Imagine Image 2.0** (xAI) | grok.com, X app, x.ai API | Region-level (masked) editing, background removal, generation from up to 5 reference images, notably improved typography; launched Aug 7–8, 2026; debuted **#2 on both the Text-to-Image and Image Editing arenas**, behind only OpenAI's GPT Image models; also available via OpenRouter and fal.ai | API: $0.04/image (1K low) – $0.08/image (2K medium); editing +$0.01 per input image; limited free generations in Grok apps |
...
| **Qwen-Image-3.0** (Alibaba) | chat.qwen.ai, Alibaba Cloud Model Studio / DashScope | Dense, information-heavy layouts — accepts up to 4,500 tokens of instructions for single-pass newspapers, storyboards, and infographic grids; renders text as small as ~10px across 12 languages; simulates UI mockups (web pages, apps, games); opened invite-only Jul 21, 2026, public to all users Aug 5, 2026 | Free (chat.qwen.ai); API: Standard $0.03/image (1K–2K), Pro $0.04/image (1K) – $0.075/image (2K) |
