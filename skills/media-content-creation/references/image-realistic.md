...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default model Jul 24 2026 (up from v8.1, default since Jun 11 2026) — aesthetic refinements, better Sref/moodboard consistency, Big Batch Draft Mode with `--sref random` for 24× faster style exploration | Paid (no free tier) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition; native 4K refinement (new in 2.1, released Jul 9 2026) plus a $0.01 fast-edit tier; debuted #2 on Image Arena (score 1280, 2.0 launched June 3, 2026) | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
...
| **Riverflow 2.5 Pro** (Sourceful) | openrouter.ai/sourceful/riverflow-v2-pro, runware.ai, replicate.com | Photorealistic product mockups, packaging, ads, brand assets — #1 across Image, Graphic Design, and Image Editing on the Design Arena benchmark (announced June 2026, up from Riverflow 2.0 Pro); 4K output, transparent background support, agentic precision for commercial imagery | API credits ($0.15/image 2K, $0.33/image 4K; no direct consumer site — API only) |
| **Qwen Image 3.0** (Alibaba) | Alibaba Cloud Bailian/Qwen platform, openrouter.ai (`qwen/qwen-image-3`, `qwen/qwen-image-3-pro`) | Text-heavy compositions — handles up to 4,500-token prompts, renders legible small text (down to ~10px) and formulas, 12-language text rendering; strong for infographics, UI mockups, ecommerce layouts; announced Jul 21 2026, GA Aug 5 2026 | No free tier (API: ~$0.03/image Standard, $0.04–$0.075/image Pro) |
