...
|------|--------|----------|
| **Midjourney v8.1 / v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.1 (released Apr 30 2026, became default Jun 11 2026) — 5× faster than v7, native 2K resolution, improved text rendering, HD mode now affordable as default; v8.2 (aesthetic refinements, better Sref/moodboard consistency, Big Batch Draft Mode) is now the default as of Sept 2026; **v9 is in development, not yet released** — no confirmed ship date | Paid (no free tier) |
...
| **GPT Image 2.5** (OpenAI) | ChatGPT / API ("Flare" fast, "Sunburst" quality variants) | Successor to GPT Image 2, launched Sept 8, 2026; ~50% lower latency, sketch-to-image input, stronger multi-turn editing; **#1 on Artificial Analysis / Arena Text-to-Image (unusually large lead, Sept 2026)** | Limited (ChatGPT Plus) |
| **GPT Image 2** (superseded by 2.5) | ChatGPT / API | Complex instructions, text in images (99% accuracy), 4K resolution, 2× faster than predecessor; launched April 21, 2026; held #1 on Artificial Analysis Text-to-Image Arena through July 2026 (Elo ~1339) | Limited (ChatGPT Plus) |
| **MAI-Image-2.6** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.6, Azure AI Foundry | Launched Aug 10–14, 2026; +79 Elo over MAI-Image-2.5; **debuted #2 on Artificial Analysis / Arena Text-to-Image (Elo ~1,335.7, Aug 2026)** behind GPT Image 2.5 | No free tier confirmed at launch |
| **Grok Imagine Image 2.0** (xAI) | grok.com/imagine, iOS/Android ("Quality Mode") | Launched Aug 7, 2026; region-based editing, multi-image input (5 references); claims #2 on Arena text-to-image and image-edit leaderboards behind GPT Image 2 / 2.5 | Consumer: grok.com/imagine; API: x.ai/api |
| **Seedream 5.0 Lite** (ByteDance) | seed.bytedance.com, openrouter.ai | Launched Aug 13, 2026 — cheaper, faster companion to Seedream 5.0 Pro (below); trades some quality for speed and cost | Limited free (via PixVerse) |
...
| **FLUX 3** (Black Forest Labs) | bfl.ai (early access) | Announced July 23, 2026 — a new multimodal family spanning image/video/audio/robot-action generation. FLUX 3 Video and FLUX 3 Action are in early access; **FLUX 3 Image has no public API, pricing, or model ID yet** as of late Sept 2026 — still gated behind an early-access request form | Not yet publicly available |
| **FLUX.2 [max]** (Black Forest Labs) | bfl.ai, fal.ai, openrouter.ai | Highest-quality FLUX model currently shipping; Grounded Generation (retrieves real-time web context during image gen); up to 10 reference images for consistent products/characters/styles; open-source [dev] variant (32B params) released alongside | API credits ($0.07/mp first output mp, $0.03/mp subsequent; [dev]: open-weights, non-commercial) |
...
## Reve 2.0 — Reported Shutdown (unconfirmed, check before recommending)

A single secondary source (a Recraft blog post comparing alternatives — note Recraft is a competitor, so treat with some skepticism) reports that Reve AI will stop image generation entirely on September 27, 2026, following an OpenAI acqui-hire of Reve's research team. This is **not independently confirmed** via a primary Reve source. Before recommending Reve 2.0 (still listed in the table above), verify app.reve.com is still live — if it returns a shutdown notice or 404, remove the Reve 2.0 row and point users to Reve alternatives instead.

## OpenAI Image API Deprecations — Scheduled Dec 1, 2026

OpenAI announced (within the Aug–Sep 2026 window) that `gpt-image-1-mini`, `gpt-image-1.5`, and `chatgpt-image-latest` are scheduled for shutdown on December 1, 2026. Not yet in effect as of this writing — no action needed today, but avoid building new integrations against these model IDs; use `gpt-image-2-5` (Flare/Sunburst) going forward.
