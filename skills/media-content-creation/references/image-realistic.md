...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; went GA and became the default model July 24, 2026 (supersedes v8.1); aesthetic refinements, better Sref/moodboard consistency, Big Batch Draft Mode (`--sref random` for 24× faster style exploration); new Edit Model replaces the old Omni/Character Reference and Retexture tools | Paid (no free tier) |
...
| **GPT Image 2.5** (Flare / Sunburst) | ChatGPT / API | Replaces GPT Image 2 as OpenAI's flagship, launched Sept 8, 2026; **Flare** (default) — 50% lower latency than GPT Image 2; **Sunburst** (premium) — highest-precision editing; **#1 and #2 on Artificial Analysis Text-to-Image and Image Editing Arenas (Sept 2026)** | Limited (ChatGPT Plus) |
| **GPT Image 2** | ChatGPT / API | Previous generation — complex instructions, text in images (99% accuracy), 4K resolution; still available, now ranks below GPT Image 2.5 and MAI-Image-2.6 on Artificial Analysis | Limited (ChatGPT Plus) |
...
| **MAI-Image-2.6 / Flash** (Microsoft) | microsoft.ai (MAI Playground), Microsoft Foundry (public preview) | Supersedes MAI-Image-2.5/Flash — +79 Elo over 2.5; #2 on Arena for both text-to-image and image editing, ahead of Google, Meta, and xAI models; strong product imagery, text rendering, and prompt adherence; Flash variant for lower cost; integrating into PowerPoint (generation) and OneDrive (photo editing) | No free tier (Microsoft Foundry preview pricing) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Supersedes Reve 2.0 — #2 overall on Arena.ai Text-to-Image (Elo 1306, +36 over 2.0); layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
...
| **Ideogram 4.0** | ideogram.ai, Together AI | Text in images, posters, signage; first open-weight T2I model from Ideogram (9.3B params, Jun 3 2026); #1 text rendering (0.97 X-Omni OCR — highest among open-weight models); native 2K resolution; bounding-box layout control; color-palette conditioning (up to 16 hex colors); inference code Apache 2.0; model weights: non-commercial license | Free tier shrank as of mid-2026 — now ~10 slow credits/day (~40 images/week), slow-queue waits up to 20 min; API unchanged: $0.03 Turbo / $0.06 Default / $0.10 Quality per image |
