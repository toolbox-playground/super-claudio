...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 became the default GA version on July 24, 2026 (up from v8.1, released Apr 30 2026) — aesthetic refinements, better Sref/moodboard consistency, Big Batch Draft Mode with `--sref random` for 24× faster style exploration | Paid (no free tier) |
...
| **GPT Image 2.5** (Flare / Sunburst) | ChatGPT / API | Supersedes GPT Image 2 (launched Sept 8, 2026): 50% lower latency, sharper edits; Flare = speed tier, Sunburst = precision tier; complex instructions, text in images, 4K resolution; **#1 on Artificial Analysis Text-to-Image Arena** | API: $8/M tokens (either tier); limited free (ChatGPT Plus) |
| **Grok Imagine Image 2.0** (xAI) | grok.com/imagine, x.ai/api | Launched Aug 7, 2026; **#2 worldwide on Artificial Analysis text-to-image and edit leaderboards**, behind only GPT Image 2.5 | API; SuperGrok subscription for consumer use |
| **Qwen Image 3.0** (Alibaba) | Alibaba Cloud Model Studio (DashScope) | Shipped July 21, 2026; closed/hosted only — breaks from Qwen-Image 1.0/2.0's Apache 2.0 open-weight pattern | API credits (no open weights) |
| **FLUX 3** (Black Forest Labs) | bfl.ai | New model family (distinct from FLUX.2) announced late July/Aug 4 2026; unified image+video+audio generation; video capability GA'd Aug 5, 2026, up to 1080p | API credits |
| **Meta Muse Image** (Meta Superintelligence Labs) | meta.ai, Meta AI app, Instagram Stories (US), WhatsApp (limited countries), fal.ai (developer/enterprise API since Sept 1, 2026) | Social-native image generation — text-to-image, multi-photo blending, @mention of public Instagram accounts for likeness reference, sketch-and-instruction editing, 30+ Instagram Story effects; agentic tool use (web search + coding invoked during generation); self-refinement at inference time (test-time compute scaling before delivering the final image); Content Seal invisible watermark; launched July 7, 2026; **#2 on Arena.ai Text-to-Image Arena (Elo 1280, July 2026)** — also #2 in single-image edit and multi-image edit arenas | Free (consumer; subscription for power users via Meta AI subscription plans); API via fal.ai |
...
## New Entrants (Aug–Sep 2026)

- **GPT Image 2.5** (OpenAI, Sept 8, 2026) supersedes GPT Image 2 — two tiers, Flare (speed) and Sunburst (precision), both at $8/M tokens; 50% lower latency and sharper edits than the prior model; currently #1 on the Artificial Analysis Text-to-Image Arena
- **Grok Imagine Image 2.0** (xAI, Aug 7, 2026) ranks #2 worldwide on Artificial Analysis text-to-image and edit leaderboards, right behind GPT Image 2.5
- **Qwen Image 3.0** (Alibaba, July 21, 2026) is closed/hosted-only via Alibaba Cloud Model Studio — notably breaking from the open-weight (Apache 2.0) pattern of Qwen-Image 1.0/2.0
- **FLUX 3** (Black Forest Labs, late July/Aug 4 2026) is a new unified image+video+audio model family, distinct from the FLUX.2 line already in the table above; video generation went GA Aug 5, 2026 at up to 1080p
- **Midjourney v8.2** left preview and became the default GA version on July 24, 2026 (previously v8.1)
- **Meta Muse Image** gained a developer/enterprise API route via fal.ai starting Sept 1, 2026, alongside its existing consumer-only access
