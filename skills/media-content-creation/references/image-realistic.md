...
|------|--------|----------|
| **Midjourney v8.2** | midjourney.com | Artistic quality, concept art, portraits; v8.2 (released Apr 14 2026, became default Jul 24 2026) — more creative/bold aesthetic, deeper Personalization (better matches your rated-image taste profile), fewer low-quality outliers; supersedes v8.1 (5× faster than v7, native 2K resolution, improved text rendering) | Paid (no free tier) |
...
| **Reve 2.1** (Reve AI) | app.reve.com | Layout-first 4K generation — builds an editable code-based layout before rendering, so you can fix a misplaced headline or resize one element without re-rolling; dedicated typography step keeps headlines, packaging labels, and captions crisp and correctly spelled; text-to-image, image editing, multi-reference composition; native 4K output; ~3× the parameters of 2.0 with stronger prompt understanding, world knowledge, spatial reasoning, and non-English text rendering; #2 on Image Arena (+36 Elo over 2.0, launched July 9, 2026) | Free tier (daily refresh); Lite $7.99/mo; Pro $19.99/mo |
...
| **Riverflow 2.5 Pro** (Sourceful) | openrouter.ai/sourceful/riverflow-v2.5-pro, runware.ai, replicate.com, riverflow.ai | Photorealistic product mockups, packaging, ads, brand assets — first model to top all three Design Arena creative categories at once: #1 Image (Elo 1408), #1 Graphic Design (Elo 1469), #1 Image Editing (Elo 1377); integrated reasoning model plans multi-step edits and judges candidates before returning a result; supersedes Riverflow 2.0 Pro (Feb 2026); launched June 4, 2026 | API credits, dynamic pricing (~$0.13/image 1024px to $0.17/image 4096px; no direct consumer site — API only) |
...
| **Qwen Image 3.0 (Pro)** (Alibaba) | chat.qwen.ai, openrouter.ai/qwen/qwen-image-3 | Dense, text-heavy layouts — newspapers, exam papers, multi-panel infographics rendered legibly in one pass; ultra-long prompts (up to 4.5K tokens), 12 languages, 20+ fonts; #5 on Artificial Analysis Text-to-Image Arena (Elo 1263, Aug 2026); released Aug 5, 2026 with no benchmarks, model card, or open weights published — independent testing suggests its edge is specifically text/layout work rather than general-purpose image quality | Free (Qwen Chat, hosted only — no self-host); API via OpenRouter ~$0.03/image |
