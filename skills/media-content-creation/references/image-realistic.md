...
| **MAI-Image-2.5 / Flash** (Microsoft) | microsoft.ai (MAI Playground), openrouter.ai/microsoft/mai-image-2.5, Azure AI Foundry | High-quality generation and precise localized editing; launched June 2, 2026 at Microsoft Build ranking #2 image editing / #3 text-to-image on Arena; now **#5 on Artificial Analysis Text-to-Image Arena (Elo 1308, Aug 2026)** as new entrants (Reve 2.1, Grok Imagine 2.0) passed it; +75 pts over MAI-Image-2 at launch, biggest gains in Text Rendering (+107) and Cartoon/Anime/Fantasy (+90); strong product imagery, text rendering, and prompt adherence; Flash variant for 2.7× lower cost; integrating into PowerPoint (generation) and OneDrive (photo editing) | No free tier (API: $47/1M image output tokens standard; $33/1M Flash; text input: $5/1M standard, $1.75/1M Flash) |
