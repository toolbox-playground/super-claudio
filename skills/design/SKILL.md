...
description: >
  ...
  Do NOT trigger for: implementing already-designed UI in code (use software-development skill),
  generating standalone images (use media-content-creation skill).
---
