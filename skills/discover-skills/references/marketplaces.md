...
| **awesome-claude-skills (ComposioHQ)** | github.com/ComposioHQ/awesome-claude-skills | Curated list of 1,000+ production-ready Claude Skills spanning document processing, dev/testing tools, data & analysis, business/marketing, creative/media, and 78 Composio SaaS app integrations; 74k+ GitHub stars; compatible with Claude.ai, Claude Code, Cursor, and Gemini CLI |
