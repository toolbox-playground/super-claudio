...
| **VoltAgent/awesome-agent-skills** | github.com/VoltAgent/awesome-agent-skills | Curated collection of 1,000+ real-world agent skills from official teams (Anthropic, Google Labs, Vercel, Stripe, Cloudflare, Figma, Sentry, Hugging Face, and more) plus community contributions — explicitly excludes mass AI-generated skills; 28,600+ GitHub stars; compatible with Claude Code, Codex, Gemini CLI, Cursor, GitHub Copilot, OpenCode, Windsurf, and more |
| **NVIDIA/skills** | github.com/nvidia/skills | Official NVIDIA-maintained skills catalog covering cuOpt, cuDF, NeMo, TAO Toolkit, Isaac robotics/physical AI, DeepStream, Jetson, and other NVIDIA product lines; installs via `npx skills add nvidia/skills`; synced daily from each product's repo; Claude Code and Codex compatible |
