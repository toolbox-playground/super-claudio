...
| **awesome-claude-skills** (ComposioHQ) | github.com/ComposioHQ/awesome-claude-skills | 75.1k+ stars — large curated list of 1,000+ production-ready Claude Skills/Plugins across 10 categories (dev tools, data/analysis, business/marketing, creative, productivity, PM integrations via Composio, security) |
