...
| **Awesome Claude Skills (Composio)** | github.com/ComposioHQ/awesome-claude-skills | 1,000+ production-ready Claude Skills and plugins spanning document processing, dev tools, data analysis, and business automation, plus pre-built automation skills for 78+ SaaS apps; 75k+ stars, Apache 2.0 licensed; compatible with Claude.ai, Claude Code, the Claude API, and other agents |
| **Awesome Claude Skills (travisvn)** | github.com/travisvn/awesome-claude-skills | Curated list of Claude Skills, resources, and tools for Claude Code workflows; 15k+ stars; includes official Anthropic skills, community-contributed skills, creation guides, and security guidance |
