...
| **Claude Plugins Community** (Anthropic GitHub) | github.com/anthropics/claude-plugins-community | Read-only mirror of Anthropic's community plugin marketplace, now covering both **Claude Code and Claude Cowork** (expanded from Code-only) — third-party plugins that passed automated security scanning; add manually: `claude plugin marketplace add anthropics/claude-plugins-community`; submit at clau.de/plugin-directory-submission; browse/install at claude.com/plugins |
| **Anthropic Knowledge Work Plugins** (Anthropic GitHub) | github.com/anthropics/knowledge-work-plugins | Official open-source plugin repo for **Claude Cowork**, compatible with Claude Code — 11 plugin collections (Productivity, Sales, Support, PM, Marketing, Legal, Finance, Data, Enterprise Search, Bio Research, Cowork Plugin Management) |
...
| **awesome-claude-plugins** (rdmgator12) | github.com/rdmgator12/awesome-claude-plugins | Community-maintained directory covering both Claude Code and Claude Cowork surfaces — 333–348 plugins across 28 categories; CC0 license, updated weekly; distinct from the Chat2AnyLLM list above |
