...
| **awesome-claude-skills (ComposioHQ)** | github.com/ComposioHQ/awesome-claude-skills | 71k+ GitHub stars; 1,000+ curated production-ready Claude Skills and plugins across document processing, development, data analysis, business/marketing, writing, and 78 pre-built SaaS integrations via Composio; actively maintained, compatible with Claude.ai, Claude Code, Claude API, Cursor, and Gemini CLI |
| **claude-skills (388 skills)** | github.com/alirezarezvani/claude-skills | 388 production-ready skills across 13 AI coding agents/platforms (Claude Code, Codex CLI, Cursor, Gemini CLI, and more), spanning engineering, marketing, product, compliance, and C-level advisory domains; also includes 118 agents, 150 custom commands, and 727 Python CLI tools |
...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 93 plugins, 202 agents, 181 skills, 105 commands; native support for Claude Code, Codex CLI, Cursor, OpenCode, Gemini CLI, and GitHub Copilot — each harness gets idiomatic artifacts from one Markdown source |
...
| **Claude Code Plugins (danielrosehill)** | github.com/danielrosehill/Claude-Code-Plugins | 148 plugins across 18 categories for developers, sysadmins, content creators, and productivity workflows; individual plugins live in separate linked repos; searchable web index at claude.danielrosehill.com; install via `/plugin install {plugin-name}@danielrosehill` |
...
| **Awesome Claude Plugins** | github.com/Chat2AnyLLM/awesome-claude-plugins | Metadata catalog of Claude marketplaces and plugins — 2,474 marketplaces, 9,456 plugins indexed (as of Aug 2026), tracked via GitHub API; updated daily |
