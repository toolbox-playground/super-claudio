...
| **Tons of Skills** | tonsofskills.com | 471 plugins, 3,069 skills, 347 agents, 30 community contributors for Claude Code; `ccpi` CLI package manager; catalog updated daily from GitHub; most comprehensive single-site collection (July 2026) |
| **claude-skills (362 skills)** | github.com/alirezarezvani/claude-skills | 362 production-ready skills across 13 AI coding agents (Claude Code, Codex CLI, Cursor, Gemini CLI, and more), spanning engineering, marketing, product, compliance, and C-level advisory domains; also includes 102 agents, 116 custom commands, and 644 Python CLI tools |
| **claude-code-marketplace (Netresearch)** | github.com/netresearch/claude-code-marketplace | 40 curated Agent Skills (TYPO3, PHP, Go, Docker, Jira, security, docs) using agentskills.io open standard — portable across Claude Code, Cursor, Copilot, Codex, Gemini CLI, and 30+ more agents |
...
| **Awesome Claude Plugins** | github.com/Chat2AnyLLM/awesome-claude-plugins | Curated list of Claude marketplaces and plugins — 192 marketplaces, 2,529 plugins indexed (167 healthy repos, 25 unavailable); updated daily (last refresh 2026-06-24) |
