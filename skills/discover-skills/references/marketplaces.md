...
| **claude-skills (386 skills)** | github.com/alirezarezvani/claude-skills | 386 production-ready skills across 13 AI coding agents (Claude Code, Codex CLI, Cursor, Gemini CLI, and more), spanning engineering, marketing, product, compliance, and C-level advisory domains; also includes 116 agents, 146 custom commands, and 706+ Python CLI tools (August 2026) |
...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 93 plugins, 202 agents, 181 skills, 105 commands; native support for Claude Code, Codex CLI, Cursor, OpenCode, Antigravity CLI, and GitHub Copilot — each harness gets idiomatic artifacts from one Markdown source (August 2026) |
...
| **Awesome Claude Plugins** | github.com/Chat2AnyLLM/awesome-claude-plugins | Metadata catalog of Claude plugin marketplaces, tracked via the GitHub API — 2,357 marketplaces enabled, 8,954 plugins discoverable (2,113 healthy repos, 244 unavailable) as of August 23, 2026; updated daily |
