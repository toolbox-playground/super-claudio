...
| **SkillsMP** | skillsmp.com | ~2.1M agent skills indexed from GitHub (2.1M+ as of July 2026; public API available); compatible with Claude Code, Codex CLI, ChatGPT, and other agents |
