...
| **Awesome Claude Skills (Composio)** | github.com/ComposioHQ/awesome-claude-skills | 1,000+ production-ready Claude Skills/Plugins spanning Claude.ai, Claude Code, Cursor, and Gemini CLI; backed by Composio's MCP Gateway; one of the largest Claude skills lists on GitHub (72.9k+ stars, added Aug 2026) |
| **Awesome Claude Skills (travisvn)** | github.com/travisvn/awesome-claude-skills | Curated awesome-list of official + community Claude Skills, particularly Claude Code-focused; smaller and more human-curated than the Composio list (14.7k+ stars) |
