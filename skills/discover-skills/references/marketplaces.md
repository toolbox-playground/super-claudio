...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 93 plugins, 202 agents, 181 skills, 105 commands; 39.2k stars; native support for Claude Code, Codex CLI, Cursor, OpenCode, Antigravity CLI, and GitHub Copilot — each harness gets idiomatic artifacts from one Markdown source (updated Aug 2026) |
| **ComposioHQ/awesome-claude-skills** | github.com/ComposioHQ/awesome-claude-skills | Curated collection of 1,000+ production-ready Claude Skills across 11 categories; 73.4k stars; spans document processing, code development, data analysis, and integrations with 78+ SaaS platforms (Slack, GitHub, Salesforce, Notion) |
