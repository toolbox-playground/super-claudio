...
| **awesome-claude-skills (ComposioHQ)** | github.com/ComposioHQ/awesome-claude-skills | 1000+ skills/plugins across Claude Code, Claude.ai, Codex, Cursor, Gemini CLI, Antigravity; ~70k GitHub stars, actively maintained; bundles Composio MCP Gateway for 1,000+ app integrations (auth, team access control, audit logs) — larger and fresher than most single-repo lists |
