...
| **SkillsMP** | skillsmp.com | Millions of indexed SKILL.md files from GitHub (self-reported counts vary widely across sources, from ~87K to 2.2M+ over 2026 — treat any specific figure as unverified); public API available; compatible with Claude Code, Codex CLI, ChatGPT, and other agents |
