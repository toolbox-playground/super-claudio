...
| **ComposioHQ/awesome-claude-skills** | github.com/ComposioHQ/awesome-claude-skills | Curated list of 1,000+ production-ready Claude Skills across 11 categories (document processing, dev tools, data analysis, business, security, SaaS integrations via Composio); 72.6k+ stars; skills portable across Claude.ai, Claude Code, and the Claude API |
