...
| **Awesome Claude Skills (travisvn)** | github.com/travisvn/awesome-claude-skills | Popular curated list of Claude Skills, resources, and tools for customizing Claude AI workflows (Claude Code focus); 14.7k+ stars, 1.9k forks; official + community skill tables, actively maintained |
| **Awesome Claude Skills (ComposioHQ)** | github.com/ComposioHQ/awesome-claude-skills | Curated collection of 1,000+ production-ready Claude Skills and Plugins spanning Claude.ai, Claude Code, the Claude API, and compatible agents (Cursor, Codex); maintained by Composio, organized by category (docs, dev tools, data analysis, business automation) |
