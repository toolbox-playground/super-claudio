...
| **Tons of Skills** | tonsofskills.com | 471 plugins, 3,179 skills, 347 agents for Claude Code (v4.33.0, Aug 2026); `ccpi` CLI package manager (`@intentsolutionsio/ccpi` on npm); catalog updated daily from GitHub; most comprehensive single-site collection |
| **Skills Directory** | skillsdirectory.com | Security-first marketplace — every skill scanned for malware, prompt injection, credential theft, unsafe commands, and data exfiltration across 50+ rules and 10 threat categories; each skill starts at a score of 100 with deductions by severity; 96,919+ skills scanned as of Aug 2026 (one of the largest security audits of agent skills); reports ~36% of skills in the wild have security flaws |
