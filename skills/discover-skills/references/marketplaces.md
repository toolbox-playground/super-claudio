...
| **awesome-claude-skills** (ComposioHQ) | github.com/ComposioHQ/awesome-claude-skills | Large curated GitHub list — 72.5k stars; 1,000+ production-ready skills across document processing, dev tools, data/analysis, business/marketing, and creative/media; includes 78 pre-built SaaS integrations via Composio's "connect-apps" plugin; cross-agent (Claude Code, Codex, Cursor, Gemini CLI) |
| **NVIDIA/skills** | github.com/nvidia/skills | Official NVIDIA-maintained catalog of 200+ verified skills for Physical AI, robotics, simulation, CUDA libraries (cuOpt, DeepStream, Jetson, NeMo, TAO Toolkit, Warp), and RAG workflows; 3,000+ stars; daily automated sync from upstream product repos; install via `npx skills add nvidia/skills --agent claude-code` |
