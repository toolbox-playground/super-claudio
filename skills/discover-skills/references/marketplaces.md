...
| **claude-skills (388 skills)** | github.com/alirezarezvani/claude-skills | 388 production-ready skills across 20 domains, supporting 13 AI coding platforms (Claude Code, Codex CLI, Cursor, Gemini CLI, and more); also includes 30+ agents, 70+ custom commands, and 580+ stdlib-only CLI tools |
...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 94 plugins, 202 agents, 183 skills, 105 commands; native support for Claude Code, Codex CLI, Cursor, OpenCode, Antigravity CLI, and GitHub Copilot — each harness gets idiomatic artifacts from one Markdown source |
| **xiaolai/claude-plugin-marketplace** | github.com/xiaolai/claude-plugin-marketplace | Central marketplace for Claude Code and Codex CLI plugins by community contributor xiaolai; cross-agent compatible; notable plugins include CC Suite (bridge across Claude Code, Codex CLI, Antigravity), Grill (deep codebase interrogation with 6 agents), and Docs Guardian (documentation freshness enforcer) |
...
| **Awesome Claude Plugins** | github.com/Chat2AnyLLM/awesome-claude-plugins | Metadata catalog tracking Claude plugin marketplaces — 2,474 marketplaces enabled, 9,456 discoverable plugins (as of 2026-08-27); counts entries via the GitHub API rather than mirroring content |
...
| **Build with Claude** | buildwithclaude.com | Hub for Claude Skills, Agents, Commands, Hooks, and Plugins; backed by github.com/davepoon/buildwithclaude, which lists curated collections (117 agents, 175 commands, 28 hooks, 26 skills, 51 bundled plugins) plus an index of external community plugins, MCP servers, and marketplaces |
