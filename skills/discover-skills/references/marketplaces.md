...
| **ComposioHQ/awesome-claude-skills** | github.com/ComposioHQ/awesome-claude-skills | 1,000+ production-ready Claude Skills curated across Claude.ai, Claude Code, Cursor, and Gemini CLI; 75k+ GitHub stars, by far the most-starred community skills list; includes the Composio MCP Gateway connecting Claude to 1,000+ SaaS apps (Slack, Gmail, Salesforce) with built-in auth |
| **travisvn/awesome-claude-skills** | github.com/travisvn/awesome-claude-skills | Claude Code-focused curated list of official Anthropic skills plus community ones (iOS automation, web fuzzing, D3.js visualization, security tools) with skill-creation guides; 15k+ GitHub stars |
