...
| **Knowledge Work Plugins** (Anthropic GitHub) | github.com/anthropics/knowledge-work-plugins | Official Anthropic repo of 11 role-based plugins (Productivity, Sales, Customer Support, Product Management, Marketing, Legal, Finance, Data, Enterprise Search, Bio-Research, Cowork Plugin Management) that turn Claude into a specialist for a role/team; built primarily for Claude Cowork, also compatible with Claude Code; file-based (markdown/JSON), no code or infra |
...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 94 plugins, 202 agents, 183 skills, 105 commands, 16 orchestrators; native support for Claude Code, Codex CLI, Cursor, OpenCode, Antigravity CLI, GitHub Copilot, and Pi — each harness gets idiomatic artifacts from one Markdown source |
| **xiaolai/claude-plugin-marketplace** | github.com/xiaolai/claude-plugin-marketplace | Central marketplace for Claude Code and Codex CLI plugins by community contributor xiaolai; cross-agent compatible; notable plugins include CC Suite (bridges and delegates across Claude Code, Codex CLI, and Antigravity), Grill (deep codebase interrogation with 6 agents), and Docs Guardian (documentation freshness enforcer) |
