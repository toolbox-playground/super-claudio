...
| **Claude Plugins Official** (Anthropic GitHub) | github.com/anthropics/claude-plugins-official | Anthropic-managed, high-quality plugin directory; 282 plugins in the marketplace catalog as of August 2026, spanning code-intelligence (LSP), external integrations (GitHub, Jira, Figma, Slack, etc.), security review, and dev-workflow plugins |
...
| **claude-skills (362 skills)** | github.com/alirezarezvani/claude-skills | 362 production-ready skills across 13 AI coding agents (Claude Code, Codex CLI, Cursor, Gemini CLI, and more), spanning engineering, marketing, product, compliance, and C-level advisory domains; also includes 30+ agents, 116 custom commands, and 644 Python CLI tools (August 2026) |
...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 92 plugins, 202 agents, 181 skills, 105 commands (August 2026); native support for Claude Code, Codex CLI, Cursor, OpenCode, Gemini CLI, and GitHub Copilot — each harness gets idiomatic artifacts from one Markdown source |
...
| **Awesome Claude Plugins** | github.com/Chat2AnyLLM/awesome-claude-plugins | Curated list of Claude marketplaces and plugins — 2,225 enabled marketplaces, 8,604 discoverable plugins indexed (live count via GitHub API, checked August 19, 2026); updated daily |
| **Awesome Claude Skills** (ComposioHQ) | github.com/ComposioHQ/awesome-claude-skills | 1,000+ production-ready Claude Skills across 15 categories (document processing, dev tools, data/analysis, business, security, and 78 Composio app-automation integrations); 72.8k+ GitHub stars; includes official Anthropic skills plus community contributions; portable to Claude Code, Cursor, and Gemini CLI |
| **Skill Store** (aiskillstore) | github.com/aiskillstore/marketplace | Security-audited skills marketplace behind skillstore.io — every submission runs through automated security scanning (dangerous code, unauthorized file access, network calls, obfuscation, credential handling) before publication; install via `npx skillstore add author/skill-name`; compatible with Claude Code, Codex, and Claude Web |
