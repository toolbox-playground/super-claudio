...
| **SkillsMP** | skillsmp.com | ~2M agent skills indexed from GitHub (1.9M+ as of June 2026; public API available); compatible with Claude Code, Codex CLI, ChatGPT, and other agents |
