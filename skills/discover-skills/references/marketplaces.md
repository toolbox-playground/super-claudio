...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 94 plugins, 203 agents, 175 skills, 109 commands, 16 orchestrators; native support for Claude Code, Codex CLI, Cursor, OpenCode, Gemini CLI, and GitHub Copilot — each harness gets idiomatic artifacts from one Markdown source |
...
| **Awesome Claude Skills** (ComposioHQ) | github.com/ComposioHQ/awesome-claude-skills | Curated list of 1,000+ production-ready Claude Skills and plugins across 12+ categories (document processing, dev tools, data analysis, business automation, creative media); 72k+ stars, 8k+ forks — one of the largest Claude skill collections on GitHub |
