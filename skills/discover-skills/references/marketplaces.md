...
| **Claude Marketplace** (official, NEW Sept 2026) | claude.com/marketplace | Anthropic's own storefront, launched September 23, 2026 — unifies 2,000+ connectors/plugins (MCP + Agent Skills, from Atlassian, Google, Microsoft, Notion, Salesforce, etc.), Claude-powered agent products (CrowdStrike, Cursor, Harvey, Lovable, Snowflake), and Claude Partner Network consulting firms (Accenture, BCG, Deloitte) in one place — distinct from the community directories below |
