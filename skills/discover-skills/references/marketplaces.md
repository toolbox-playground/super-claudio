...
| **Awesome Claude Skills** (Composio) | github.com/ComposioHQ/awesome-claude-skills | Curated list of 1,000+ production-ready Claude Skills and plugins spanning Claude.ai, Claude Code, and other coding agents (Codex CLI, Cursor, Gemini CLI, Antigravity); 71k+ GitHub stars; bundles a `connect-apps` plugin for real actions (email, Slack, issue creation) via Composio's 1,000+ app integrations |
