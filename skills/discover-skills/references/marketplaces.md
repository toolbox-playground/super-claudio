...
| **Build with Claude** | buildwithclaude.com | Plugin marketplace and discovery hub — indexes 20,000+ community plugins, 4,500+ MCP servers, and 1,100+ external marketplaces; also maintains its own curated collections (117 agents, 175 commands, 51 plugins, 26 skills); install via `/plugin marketplace add davepoon/buildwithclaude` |
| **awesome-claude-code (hesreallyhim)** | github.com/hesreallyhim/awesome-claude-code | Widely-cited, actively maintained curated list of Claude Code resources — skills, hooks, slash-commands, agent orchestrators, status lines, developer tooling, and plugins |
