...
| **Skills.sh** (Vercel Labs) | skills.sh | npm-style CLI package manager for agent skills — `npx skills add <repo>`, `npx skills find`; Vercel-backed; launched January 2026; community-driven with versioning and updates; GitHub: vercel-labs/skills; compatible with Claude Code, Cursor, Codex, and 76+ agents |
...
| **Tons of Skills** | tonsofskills.com | 471 plugins, 3,069 skills, 347 agents for Claude Code; `ccpi` CLI package manager; catalog updated daily from GitHub; most comprehensive single-site collection (Aug 2026) |
...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 91 plugins, 202 agents, 180 skills, 105 commands; native support for Claude Code, Codex CLI, Cursor, OpenCode, Gemini CLI, and GitHub Copilot — each harness gets idiomatic artifacts from one Markdown source |
...
| **Awesome Claude Plugins** | github.com/Chat2AnyLLM/awesome-claude-plugins | Curated list of Claude marketplaces and plugins — 192 marketplaces, 2,529 plugins indexed; updated daily |
| **Awesome Claude Code & Skills** | github.com/GetBindu/awesome-claude-code-and-skills | Curated meta-directory of skills, plugins, and marketplace repos spanning engineering, security, marketing, and productivity domains |
