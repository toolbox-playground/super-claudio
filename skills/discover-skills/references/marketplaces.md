...
| **Tons of Skills** | tonsofskills.com | 471 plugins, 3,179 skills, 347 agents for Claude Code; `ccpi` CLI package manager; catalog updated daily from GitHub; most comprehensive single-site collection (August 2026) |
