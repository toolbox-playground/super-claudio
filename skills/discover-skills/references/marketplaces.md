...
| **Claude Plugins Official** (Anthropic GitHub) | github.com/anthropics/claude-plugins-official | Anthropic-managed, high-quality plugin directory; 286 plugins in the marketplace catalog as of September 2026 (up from ~256 in July 2026) |
...
| **Skills.sh** (Vercel Labs) | skills.sh | npm-style CLI package manager for agent skills — `npx skills add <repo>`, `npx skills find`; Vercel-backed; launched January 2026; community-driven with versioning and updates; GitHub: vercel-labs/skills; compatible with Claude Code, Cursor, Codex, OpenCode, and 77+ agents total (up from 40+) |
...
| **claude-skills (388 skills)** | github.com/alirezarezvani/claude-skills | 388 production-ready skills across 13 AI coding agents (Claude Code, Codex CLI, Cursor, Gemini CLI, and more), spanning engineering, marketing, product, compliance, and C-level advisory domains; also includes 118 agents, 150 custom commands, and 727 Python CLI tools (grown from 345/30+/70+/602 as of mid-2026); 5,200+ GitHub stars |
...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 94 plugins, 202 agents, 183 skills, 105 commands (grown from 83/191/155/102 as of mid-2026); native support for Claude Code, Codex CLI, Cursor, OpenCode, Antigravity CLI, and GitHub Copilot (Gemini CLI dropped from the supported list since mid-2026) — each harness gets idiomatic artifacts from one Markdown source |
| **xiaolai/claude-plugin-marketplace** | github.com/xiaolai/claude-plugin-marketplace | Central marketplace for Claude Code and Codex CLI plugins by community contributor xiaolai; cross-agent compatible; notable plugins include CC Suite (bridge across Claude Code, Codex CLI, Gemini CLI), Grill (deep codebase interrogation with 6 agents), and Docs Guardian (documentation freshness enforcer) |
| **ananddtyagi/cc-marketplace** | github.com/ananddtyagi/cc-marketplace | Specialized AI agents with domain expertise (accessibility-expert, frontend-developer, devops-automator); synced from live database; notable plugins: Lyra (prompt optimization), Ultrathink (4-agent coordinator for coding tasks); also indexed on lobehub.com/skills |
| **Awesome Claude Plugins** | github.com/Chat2AnyLLM/awesome-claude-plugins | Curated, auto-refreshed list of Claude marketplaces and plugins — 2,474 enabled marketplaces, 9,456 discoverable plugins as of August 27, 2026 (up sharply from 76/1,199 earlier in the year); updated daily |
| **ComposioHQ/awesome-claude-skills** | github.com/ComposioHQ/awesome-claude-skills | Large curated list of 1,000+ production-ready skills and plugins spanning document processing, dev tools, data analysis, business automation, and 78+ SaaS app integrations (Slack, GitHub, Notion, Salesforce); 74.4k GitHub stars; cross-agent (Claude.ai, Claude Code, Codex, Cursor, Gemini CLI, Antigravity, Windsurf) |
