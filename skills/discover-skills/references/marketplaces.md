...
| **Tons of Skills** | tonsofskills.com | 471 plugins, 3,069 skills, 347 agents for Claude Code (Aug 2026); `ccpi` CLI package manager (backed by github.com/jeremylongshore/claude-code-plugins-plus-skills); catalog updated daily from GitHub; most comprehensive single-site collection |
| **claude-skill-registry** | github.com/majiayu000/claude-skill-registry | Largest searchable index of Claude Code skills; aggregated from GitHub + community sources with daily auto-update (crawl/validate/dedupe/security-scan via GitHub Actions); web search UI at majiayu000.github.io/claude-skill-registry-core/; also offers a CLI and JSON API (launched 2026) |
| **AI Skill Store** | skillstore.io, github.com/aiskillstore/marketplace | Security-audited skills for Claude Code, Codex, and Claude Web — every skill ships with a published automated security audit; install via `skillstore` CLI; submissions go through skillstore.io before publishing to the GitHub marketplace |
