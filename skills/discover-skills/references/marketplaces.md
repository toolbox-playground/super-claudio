...
| **ComposioHQ/awesome-claude-skills** | github.com/ComposioHQ/awesome-claude-skills | Curated list of 1,000+ production-ready Claude Skills and Plugins spanning Claude.ai, Claude Code, Claude API, Cursor, Gemini CLI, Codex, and Antigravity; 11 categories (document processing, dev tools, business, security, and more); 74k+ stars, actively maintained |
| **travisvn/awesome-claude-skills** | github.com/travisvn/awesome-claude-skills | Curated list of Claude Skills, resources, and tools for customizing Claude AI workflows, particularly Claude Code; official + community skills with tutorials on skill creation and security guidelines; 14.9k+ stars |
