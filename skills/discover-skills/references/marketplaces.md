...
| **Claude Marketplace** (official) | claude.com/marketplace | Newer unified catalog (launched Sep 23, 2026) consolidating connectors, plugins, Claude-powered agent products, and service-partner listings — 2,000+ connectors/plugins total; sub-pages: `/marketplace/plugins` (340+ plugins), `/marketplace/connectors-plugins`, `/marketplace/service-partners`; likely successor/superset of claude.ai/customize |
