...
| **Awesome Claude Skills** (ComposioHQ) | github.com/ComposioHQ/awesome-claude-skills | 1,000+ production-ready Claude Skills across document processing, dev tools, data analysis, and business automation; 73k+ GitHub stars, actively maintained; includes Composio's `connect-apps` plugin for real-world actions (email, Slack, issue creation) across 1,000+ integrated apps |
