...
| **claude-skills (388 skills)** | github.com/alirezarezvani/claude-skills | 388 production-ready skills across 20 domains for 13 AI coding agents (Claude Code, Codex CLI, Cursor, Gemini CLI, and more), spanning engineering, marketing, product, compliance, and C-level advisory domains; also includes 30+ agents, 70+ custom commands, and 727 Python CLI tools |
...
| **wshobson/agents** | github.com/wshobson/agents | Multi-harness marketplace: 94 plugins, 202 agents, 183 skills, 105 commands, 16 orchestrators; native support for Claude Code, Codex CLI, Cursor, OpenCode, Gemini CLI, GitHub Copilot, and Antigravity CLI — each harness gets idiomatic artifacts from one Markdown source |
